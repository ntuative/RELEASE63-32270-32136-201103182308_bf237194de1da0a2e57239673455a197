package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private static const const_1331:int = 10;
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_248)
            {
               _loc3_ = this.var_248[_loc1_];
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            _loc6_ = new BitmapDataAsset(this.var_363.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_363.setAsset(param1,_loc6_);
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_622 != null)
         {
            if(param1 || this.var_622.length > const_1331)
            {
