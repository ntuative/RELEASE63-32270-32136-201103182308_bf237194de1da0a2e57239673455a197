package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_165:IRoomManagerListener;
      
      private var var_2897:IRoomContentLoader;
      
      private var var_639:IRoomObjectFactory = null;
      
      private var var_524:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1181:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_577,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_731,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_639 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_639 == null || this.var_524 == null)
         {
            return;
         }
         this._state = const_1540;
         if(this.var_1181 != null)
         {
            _loc1_ = this.var_1181;
            this.var_1181 = null;
            this.initialize(_loc1_,this.var_165);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_641.indexOf(_loc5_) < 0)
            {
               this.var_58.loadObjectContent(_loc5_,events);
               this.var_641.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_639.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_639 != null)
         {
            return this.var_639.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_803)
         {
            return;
         }
         if(this.var_58 == null)
         {
            this._state = const_803;
            return;
         }
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_641.length == 0)
            {
               this._state = const_733;
               if(this.var_165 != null)
               {
                  this.var_165.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_803;
            this.var_165.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_165 != null)
            {
               this.var_165.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_967.indexOf(_loc2_) < 0)
         {
            this.var_967.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_967.length > 0)
         {
            _loc2_ = this.var_967[0];
            this.var_967.splice(0,1);
            _loc3_ = this.var_58.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_165 != null)
               {
                  this.var_165.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_165 != null)
            {
               this.var_165.contentLoaded(_loc2_,true);
            }
            if(this.var_641.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_524 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_639.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_165 != null)
                              {
                                 this.var_165.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
