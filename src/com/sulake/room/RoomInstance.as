   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_276 != null)
         {
            ...
            {
               _loc3_ = this.var_276.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1400.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_613[param1] != param2)
         {
            this.var_613[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1399.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_276.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_276.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_276.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_276.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
