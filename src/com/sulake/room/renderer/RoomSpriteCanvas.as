package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_600:Point = new Point(0,0);
      
      private static const const_332:int = 50;
      
      private static const const_1335:int = 50;
      
      private static const const_1334:Number = 60;
      
      private static const const_1332:Number = 50;
      
      private static const const_1333:int = 300;
      ...
      private var var_513:Point;
      
      private var var_259:BitmapDataCache;
      ...
      private var var_1425:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2499:Number = -1.0E7;
      
      private var var_2498:Number = -1.0E7;
      ...
      private var var_486:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_259 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_948 = new ColorTransform();
         this.var_947 = new Matrix();
      ...
      {
         this.var_513.x -= param1 - this.var_627;
         this.var_627 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_513.y -= param1 - this.var_628;
         this.var_628 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_891 = true;
            if(this.var_138 != null && !this.var_260.contains(this.var_138))
            {
               this.var_260.addChild(this.var_138);
               this.var_97.mask = this.var_138;
            }
         }
         else if(!param1 && this.var_891)
         {
            ...
            if(this.var_138 != null && this.var_260.contains(this.var_138))
            {
               this.var_260.removeChild(this.var_138);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_260.numChildren > 0)
            {
               this.var_260.removeChildAt(0);
            }
            this.var_260 = null;
         }
         this.var_97 = null;
         ...
         if(this.var_625 != null)
         {
            ...
            {
               this.cleanSprite(this.var_625[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_625 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_756 != this.var_2497 || this.var_759 != this.var_2500)
         {
            _loc8_ = true;
         }
         if(this.var_97.x != this.var_627 || this.var_97.y != this.var_628)
         {
            this.var_97.x = this.var_627;
            this.var_97.y = this.var_628;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_514.sortOn("z",0 | 0);
         if(_loc5_ < this.var_514.length)
         {
            this.var_514.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_514[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2497 = this.var_756;
         this.var_2500 = this.var_759;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1426 > 0)
         {
            ...
            if(_loc2_ <= const_1333)
            {
               ++this.var_757;
               if(this.var_757 == const_332 + 1)
               {
                  this.var_486 = _loc2_;
               }
               else if(this.var_757 > const_332 + 1)
               {
                  _loc3_ = Number(this.var_757 - const_332);
                  this.var_486 = this.var_486 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  if(this.var_757 > const_332 + const_1335)
                  {
                     if(!this.var_1163 && this.var_486 > const_1334)
                     {
                        this.var_1163 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1163 && this.var_486 < const_1332)
                     {
                        this.var_1163 = false;
                        Logger.log("Room canvas updating fast again - now entering normal frame mode...");
                     }
                     this.var_757 = const_332;
                  }
               }
            }
         }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1789 && this.var_1163);
         ...
         _loc13_ += int(this.var_756 / 2);
         _loc14_ += int(this.var_759 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_627;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_628;
                  if(_loc19_ < this.var_756 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_759 && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_514.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_627;
                     _loc17_.y = _loc20_ - this.var_628;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_625.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_758 || this.var_758 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_514.length)
         {
            return null;
         }
         return this.var_514[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_259.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_259.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_259.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_947.identity();
            this.var_947.scale(-1,1);
            this.var_947.translate(data.width,0);
            finalData.draw(data,this.var_947);
            if(name.length > 0)
            {
               this.var_259.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_600);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_948.redMultiplier = tR;
            this.var_948.greenMultiplier = tG;
            this.var_948.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_948);
            if(name.length > 0)
            {
               this.var_259.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_627;
         param2 -= this.var_628;
         this.var_513.x = param1;
         this.var_513.y = param2;
         if(this.var_1162 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1788;
         }
         this.var_1788 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1162;
         return this.var_1788;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_756 / 2;
         var _loc12_:Number = param2 - this.var_759 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1787,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_624.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_624.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2499 || param2 != this.var_2498)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_624.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_624.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_365 != null && param1 != null)
         {
            this.var_365.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_365 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_365.getKey(_loc1_);
            _loc3_ = this.var_365.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1425.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1162 == 0)
         {
            this.checkMouseHits(this.var_513.x,this.var_513.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1162 = 0;
         ++this.var_1787;
      }
