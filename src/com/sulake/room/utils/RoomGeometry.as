package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1089:Number = 32;
      ...
      private var var_1645:Number = 1.0;
      
      private var var_1647:Number = 1.0;
      
      private var var_1644:Number = 1.0;
      
      private var var_90:Vector3d;
      
      private var var_339:Vector3d;
      
      private var var_2844:Number = -500.0;
      
      private var var_2845:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1644 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1646.assign(this.var_156);
         return this.var_1646;
      }
      
      public function get location() : IVector3d
      {
         this.var_480.assign(this.var_90);
         this.var_480.x *= this.var_409;
         this.var_480.y *= this.var_410;
         this.var_480.z *= this.var_411;
         return this.var_480;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_339);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_409 != param1 * this.var_1645)
         {
            this.var_409 = param1 * this.var_1645;
            ++this.var_157;
         }
      }
      ...
      {
         if(this.var_410 != param1 * this.var_1647)
         {
            this.var_410 = param1 * this.var_1647;
            ++this.var_157;
         }
      }
      ...
      {
         if(this.var_411 != param1 * this.var_1644)
         {
            this.var_411 = param1 * this.var_1644;
            ++this.var_157;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_90.x /= this.var_409;
         this.var_90.y /= this.var_410;
         this.var_90.z /= this.var_411;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_339.x;
         var _loc3_:Number = this.var_339.y;
         var _loc4_:Number = this.var_339.z;
         this.var_339.assign(param1);
         if(this.var_339.x != _loc2_ || this.var_339.y != _loc3_ || this.var_339.z != _loc4_)
         {
            ++this.var_157;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1076.assign(_loc22_);
         }
         else
         {
            this.var_1076.assign(_loc17_);
         }
         ++this.var_157;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_409;
         _loc2_.y *= this.var_410;
         _loc2_.z *= this.var_411;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1076);
         if(_loc3_ < this.var_2844 || _loc3_ > this.var_2845)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_410;
            _loc2_.z *= this.var_411;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1076);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_155,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_90.x * this.var_409,this.var_90.y * this.var_410,this.var_90.z * this.var_411);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_156;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_409,param2.y * this.var_410,param2.z * this.var_411);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_409,param3.y * this.var_410,param3.z * this.var_411);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_409,param4.y * this.var_410,param4.z * this.var_411);
