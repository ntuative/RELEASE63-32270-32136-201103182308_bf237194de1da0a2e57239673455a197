package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_249:MessengerView;
      ...
      {
         var _loc2_:Conversation = this.var_601.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_601.setSelected(_loc2_);
            this.var_249.openMessenger();
            this.var_249.refresh();
         }
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_601.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_601.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_549.playSound(HabboSoundTypesEnum.const_1024);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_178.getKey("url.prefix",_loc2_);
      ...
      {
         this.var_601 = new Conversations(new ConversationsDeps(this));
         this.var_249 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         ...
         this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_249.isMessengerOpen())
            {
               this.var_249.close();
            }
            else
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1192,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_601.addMessageAndUpdateView(param1);
         if(!this.var_249.isMessengerOpen())
         {
            if(this.var_549 != null)
            {
               this.var_549.playSound(HabboSoundTypesEnum.const_1107);
            }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_601.addMessageAndUpdateView(_loc3_);
      }
