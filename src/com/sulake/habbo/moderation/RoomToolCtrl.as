package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_498:ITextFieldWindow;
      
      private var var_570:Boolean = true;
      
      private var var_940:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_394));
         Logger.log("BEGINNING TO SHOW: " + this.var_394);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1560;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_394);
         if(param1.flatId != this.var_394)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_394);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_498 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_498.procedure = this.onInputClick;
         this.var_1122 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1122);
         this.var_1122.procedure = this.onSelectTemplate;
         this.var_940 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_878,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_570 || this.var_498.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_940.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1460,_loc2_,this.var_498.text,"",""));
         if(this.var_1413.isSelected || this.var_1414.isSelected || this.var_940.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1413.isSelected,this.var_1414.isSelected,this.var_940.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1607);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1581);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1122.selection];
         if(_loc3_ != null)
         {
            this.var_570 = false;
            this.var_498.text = _loc3_;
         }
      }
   }
}
