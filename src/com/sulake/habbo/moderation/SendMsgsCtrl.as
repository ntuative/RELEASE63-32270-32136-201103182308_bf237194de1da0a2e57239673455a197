package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         return WindowTracker.const_1658;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.messageTemplates[this.var_1122.selection];
         if(_loc3_ != null)
         {
            this.var_570 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModMessageMessageComposer(this.var_1395,this.var_498.text,this.var_1396));
         this.dispose();
      }
