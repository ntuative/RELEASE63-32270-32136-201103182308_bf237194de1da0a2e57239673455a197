package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_959:int = 60;
      
      private static const const_957:int = 3600;
      
      private static const const_960:int = 86400;
      
      private static const const_958:int = 31536000;
      ...
      public static function method_2(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_959) + " mins ago";
         }
         ...
         {
            return Math.round(param1 / const_960) + " days ago";
         }
         return Math.round(param1 / const_958) + " years ago";
      }
      ...
      public function refresh() : void
      {
         ...
         this.setTxt(_loc1_,"registered_txt",method_2(this._data.minutesSinceRegistration * 60));
         this.setTxt(_loc1_,"last_login_txt",method_2(this._data.minutesSinceLastLogin * 60));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1134.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1134.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1155,this._data.userId),this._callerFrame,this.var_1133,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1133,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1396),this._callerFrame,this.var_1133,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1396),this._callerFrame,this.var_1133,false,true);
      }
