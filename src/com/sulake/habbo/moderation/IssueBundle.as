package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_735:IssueMessageData = null;
      
      private var var_734:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2361 = param2.pickerUserId;
         this.var_2390 = param2.pickerUserName;
         this.var_1322 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1132 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1131;
         }
         if(this.var_735 == null || param1.timeStamp < this.var_735.timeStamp)
         {
            this.var_735 = param1;
         }
         if(this.var_734 == null || param1.priority > this.var_734.timeStamp)
         {
            this.var_734 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1132 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1131;
            }
            if(this.var_735 == _loc2_)
            {
               this.var_735 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_734;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_735;
         if(_loc2_ == null)
         {
