package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2031:String = "my_issues";
      
      private const const_2032:String = "open_issues";
      
      private const const_2033:String = "picked_issues";
      
      private const const_2067:String = "closed_issues";
      ...
      private var var_1806:IIssueBrowserView;
      
      private var var_1808:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_368.view.width = this.var_264.container.width;
         this.var_368.view.height = this.var_264.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2031:
               ...
               {
                  this.var_1807 = new MyIssuesView(this.issueManager,this,this.var_264.container);
               }
               return this.var_1807;
            case this.const_2032:
               if(this.var_1806 == null)
               {
                  this.var_1806 = new OpenIssuesView(this.issueManager,this,this.var_264.container);
               }
               return this.var_1806;
            case this.const_2033:
               if(this.var_1808 == null)
               {
                  this.var_1808 = new PickedIssuesView(this.issueManager,this,this.var_264.container);
               }
