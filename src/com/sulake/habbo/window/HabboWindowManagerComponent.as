package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_422:uint = 3;
      
      private static const const_1351:uint = 1;
      ...
      private var var_960:IWindowRenderer;
      
      private var var_959:ISkinContainer;
      
      private var var_266:Array;
      
      private var var_1446:IEventDispatcher;
      
      private var var_1180:Boolean = false;
      
      private var var_1830:ProfilerOutput;
      
      private var var_1447:ProfilerAgentTask;
      
      private var var_1448:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_959 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_960 = new WindowRenderer(this.var_959);
         this._windowContextArray = new Array(const_422);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_422)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_960,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_263 = this._windowContextArray[const_1351];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1830)
            {
               this.var_1830 = new ProfilerOutput(context,this,this.var_960);
            }
            this.var_1830.profiler = _loc3_;
            this.var_1447 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1447);
            this.var_1448 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1448);
            this.var_1180 = true;
         }
      }
      ...
      {
         return this.var_959.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_263.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1446.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_422 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1446.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_422)
         {
         ...
         this.var_1446.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1444,new Date().getTime().toString());
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_587,
            "style":WindowStyle.const_174,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
