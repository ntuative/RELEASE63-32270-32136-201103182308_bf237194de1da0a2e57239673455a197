package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_915.push(_loc11_);
                  this.var_916.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_915.push(new XML());
               this.var_916.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_916[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1402 == true || this.var_914 == 0)
         {
            if(this.var_915.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_915.length)
               {
                  this._frame = 0;
                  ++this.var_914;
               }
      ...
      {
         return this.var_915.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1402 == false && this.var_914 == 1 && this.var_1743 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_916.length)
         {
            _loc2_ = this.var_916[this._frame];
