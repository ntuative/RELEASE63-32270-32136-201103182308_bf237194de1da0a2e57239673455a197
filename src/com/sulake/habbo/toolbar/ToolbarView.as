package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_544:String = "LEFT";
      
      private var var_174:Number = 50;
      ...
      private var var_1990:Number = 15;
      
      private var var_1989:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_174 = this._window.width;
         this.var_235 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_62,HabboWindowStyle.const_1007,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1261 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1261)
         {
         ...
         this.var_1990 = _loc8_.toolbar.@min_group_margin;
         this.var_1989 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_280,param1,param2,param3,this._window,this.var_299);
         this.createGroupsFromXmlList(_loc10_,this.var_669,param1,param2,param3,this.var_235,this.var_299);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_174);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_174,this.var_544,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_544);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_174,this.var_544);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_174,this.var_544);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1034);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_669.length)
         {
            _loc2_ = this.var_669[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_235 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_235.x = this.var_174 + this.var_1989;
               this.var_235.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_174;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_174;
               this._window.y = 0;
               this.var_235.x = 0;
               this.var_235.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_174;
               this._window.x = 0;
               this._window.y = 0;
               this.var_235.x = 0;
               this.var_235.y = this.var_174 + this.var_1989;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_174;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_174;
               this.var_235.x = 0;
               this.var_235.y = 0;
               _loc4_ = this._window.width;
         }
         ...
         else
         {
            ...
            if(this.var_280.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_1990,(this._window.height - _loc5_ * _loc8_ - this._toolbarMarginTop - this._toolbarMarginBottom) / (this.var_280.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1990,(this._window.width - _loc5_ * _loc8_ - this._toolbarMarginTop - this._toolbarMarginBottom) / (this.var_280.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_280.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_544;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1261 && this.var_1530)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_544)
            {
               this.var_544 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_556);
                  _loc3_.orientation = this.var_544;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_174)
         {
            return "RIGHT";
         }
         ...
         if(param2 >= _loc3_.height - this.var_174)
         {
            return "BOTTOM";
         }
         return null;
