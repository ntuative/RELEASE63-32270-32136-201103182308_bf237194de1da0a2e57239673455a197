package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1483:LogoutController;
      ...
      {
         this.var_17 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_291.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","HabboRoomWidgetLib_user_tag_highlighted") == "true")
         {
            this.var_1483 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_17 == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1196,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1212,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1141,this.onHideWindowEvent);
         this._state = true;
