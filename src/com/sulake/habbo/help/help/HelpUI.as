package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_361 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103182303));
         this.var_188 = param5;
         this.var_119 = new Map();
         this.var_119.add(HabboHelpViewEnum.const_1644,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_197,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_477,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_286,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_248,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_343,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_865,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_260,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_119.add(HabboHelpViewEnum.const_1047,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_119.add(HabboHelpViewEnum.const_1014,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_837,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_119.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_119.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_510.length == 0 || param1 != this.var_361)
            {
               this.var_510.push(this.var_361);
            }
         }
         this.var_361 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_260:
               this.showUI(HabboHelpViewEnum.const_260);
               break;
            case CallForHelpResultEnum.const_1126:
               this.showUI(HabboHelpViewEnum.const_1014);
               break;
            case CallForHelpResultEnum.const_1037:
               this.showUI(HabboHelpViewEnum.const_1047);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_119.getValue(HabboHelpViewEnum.const_197) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_572));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_119.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_119.getValue(this.var_361);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2452 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2453;
         this._window.width = _loc1_.width + this.var_2452;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_510.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_361 == HabboHelpViewEnum.const_197)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_360.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_361 == HabboHelpViewEnum.const_197 || this.var_510.length == 0)
         {
            return;
         }
         if(this.var_360 == null)
         {
            ...
            this.var_360 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_360.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_360.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_360 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_360 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_360 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
