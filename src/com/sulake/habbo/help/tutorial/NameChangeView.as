package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1404:uint = 13232628;
      
      private static var var_1751:uint = 11129827;
      ...
      private var var_1146:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1750 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_741)
         {
            this.var_741 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_741)
            {
               return;
            }
            this._window.content.addChild(this.var_741);
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_505);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_829:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_831:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_828:
               break;
            case ChangeUserNameResultMessageEvent.var_832:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_830:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1034 || param1 == ChangeUserNameResultMessageEvent.var_1035)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1146 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1146.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1404;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_505 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_505);
               break;
