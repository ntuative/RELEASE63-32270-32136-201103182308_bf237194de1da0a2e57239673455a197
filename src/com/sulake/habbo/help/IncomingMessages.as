package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new FaqSearchResultsMessageEvent(this.method_6));
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2134 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_23.tellUI(HabboHelpViewEnum.const_837);
      }
      ...
      {
         this.var_23.showUI(HabboHelpViewEnum.const_343);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_477);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_286,_loc6_);
      }
      ...
      private function method_6(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_1105);
         this.var_23.tellUI(HabboHelpViewEnum.const_1105,_loc5_);
      }
