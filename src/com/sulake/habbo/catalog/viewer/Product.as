package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1632:IProductData;
      ...
      {
         super();
         this.var_1631 = param1.productType;
         this.var_1634 = param1.furniClassId;
         this.var_1338 = param1.extraParam;
         this.var_1339 = param1.productCount;
         this.var_1633 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_83:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1338);
               break;
