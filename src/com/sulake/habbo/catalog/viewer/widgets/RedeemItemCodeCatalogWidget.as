package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_854:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_853.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_853 = null;
         }
         if(this.var_854 != null)
         {
            this.var_854.removeEventListener(WindowKeyboardEvent.const_204,this.windowKeyEventProcessor);
            this.var_854 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_853 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_853 != null)
         {
            this.var_853.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_854 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_854 != null)
         {
            this.var_854.addEventListener(WindowKeyboardEvent.const_204,this.windowKeyEventProcessor);
         }
         return true;
      }
