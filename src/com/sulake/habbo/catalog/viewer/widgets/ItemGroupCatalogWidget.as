package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_608[this.var_1123][this.var_1730];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1123 = var_1041.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1123];
         var _loc3_:Array = this.var_608[this.var_1123] as Array;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_435 || _loc1_.pricingModel == Offer.const_494)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_83 || _loc3_.productType == ProductTypeEnum.const_86)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_608.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_608[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
