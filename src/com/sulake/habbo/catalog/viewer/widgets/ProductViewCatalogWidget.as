package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1795:Point;
      
      private var var_515:IItemGridWindow;
      
      private var var_1430:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_950 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1167 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1795 = new Point(this.var_86.x,this.var_86.y);
         this.var_515 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1430 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1794 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_950.text = _loc4_;
         this.var_1167.text = _loc5_;
         this.var_950.height = this.var_950.textHeight + 5;
         this.var_1167.y = this.var_950.y + this.var_950.height;
         this.var_1167.height = Math.max(130,this.var_1167.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_463:
                  _loc6_ = this.var_1794.clone();
                  if(this.var_515 != null)
                  {
                     this.var_515.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_515,this.var_1430,this.var_1939);
                     this.var_515.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_245:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_322,AvatarAction.const_447);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2505)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2505 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1795.x;
            this.var_86.y = this.var_1795.y;
            if(param3 != null)
            {
