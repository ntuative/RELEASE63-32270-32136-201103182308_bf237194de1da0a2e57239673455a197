package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1728:String = "ctlg_";
      ...
      private var var_1136:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1135);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1135);
      }
      ...
      {
         var _loc2_:String = const_1728 + param1;
         ...
         this.var_2056 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2056) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1687:
               if(this.var_1136 == null)
               {
                  this.var_1136 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1136);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1666:
               ...
               break;
            case CatalogWidgetEnum.const_1480:
            ...
            case CatalogWidgetEnum.const_1552:
               ...
               break;
            case CatalogWidgetEnum.const_1430:
