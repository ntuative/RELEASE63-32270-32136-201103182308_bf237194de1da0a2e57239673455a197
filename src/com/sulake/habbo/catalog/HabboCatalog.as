package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_343:ICatalogNavigator;
      ...
      private var var_2278:GiftWrappingConfiguration;
      
      private var var_1096:ClubGiftController;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_343.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_178.getKey("client.credits.embed.enabled","HabboRoomWidgetLib_user_tag_highlighted") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_178.getKey("link.format.credits","/credits");
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_107.getActivityPointsForType(Purse.const_179)));
         var _loc1_:int = 0;
      ...
      {
         this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_343 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1681 = param1.session.isPrivateRoom;
               if(this.var_91 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1096 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_343.buildCatalogIndex(_loc2_);
         if(this.var_713 && this.var_713 != "")
         {
            this.var_343.openPage(this.var_713);
            this.var_713 = "";
            this.var_887 = -1;
         }
         else if(this.var_887 > -1)
         {
            this.var_343.openPageById(this.var_887,this.var_1682);
            this.var_887 = -1;
            this.var_1682 = -1;
            this.var_713 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2279 && this.var_549 != null)
         {
            this.var_549.playSound(HabboSoundTypesEnum.const_1121);
         }
         this.var_2279 = false;
         if(this.var_298 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_66,this.var_107.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2280 && this.var_549 != null)
         {
            this.var_549.playSound(HabboSoundTypesEnum.const_1098);
         }
         this.var_2280 = false;
         if(this.var_298 != null)
         {
         ...
         if(_loc2_.type == Purse.const_179)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_103,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_103,_loc2_.points["null"]));
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1096.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2278 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_712.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_712.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_178.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_178.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_187)
         {
            _loc3_ = this.var_178.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
