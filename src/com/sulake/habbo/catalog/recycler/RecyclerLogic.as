package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_955:int = 0;
      
      private static const const_419:int = 1;
      ...
      {
         return this.var_602 != const_955;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1715 != RecyclerStatusMessageEvent.const_1084;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_602 == const_419;
      }
      ...
      {
         this.var_602 = const_954;
         this.var_116 = new Array(const_178);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1715)
         {
            case RecyclerStatusMessageEvent.const_1469:
               this.var_602 = const_419;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1084:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1616:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1064:
               if(this.var_17 != null)
               {
                  this.var_17.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1426:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_116.length < const_178)
         {
            return false;
         }
         var _loc1_:int = 0;
