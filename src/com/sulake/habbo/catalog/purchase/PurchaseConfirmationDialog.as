package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2022:int = 10;
      ...
      private const const_1737:uint = 4.294967295E9;
      
      private const const_2021:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_83:
                  ...
                  break;
               case ProductTypeEnum.const_245:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1731 = _loc1_.stuffTypes;
            this.var_733 = _loc1_.boxTypes;
            this.var_732 = _loc1_.ribbonTypes;
            this.var_1126 = this.var_1731[0];
            this.var_351 = this.var_733[0];
            this.var_350 = this.var_732[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_350 < 0)
         {
            this.var_350 = this.var_732.length - 1;
         }
         if(this.var_350 > this.var_732.length - 1)
         {
            this.var_350 = 0;
         }
         if(this.var_351 < 0)
         {
            this.var_351 = this.var_733.length - 1;
         }
         if(this.var_351 > this.var_733.length - 1)
         {
            this.var_351 = 0;
         }
         var _loc1_:int = this.var_733[this.var_351] * 1000 + this.var_732[this.var_350];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1126,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1393 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1731;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_733[this.var_351]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_732[this.var_350]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_92,this.var_1392,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_92.offerId,this.var_1392);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_108:
               ...
               for each(_loc7_ in this.var_221)
               {
                  ...
                  if(_loc5_.length >= this.const_2022)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2386 = _loc3_.text;
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN:
               ...
               break;
            case WindowKeyboardEvent.const_381:
      ...
      {
         if(this.var_250 == null || !this.var_250.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_250.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_250 == null)
         {
            this.var_250 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_610 == null)
         {
            this.var_610 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_610.procedure = this.suggestionsEventHandler;
         }
         if(this.var_250 == null || this.var_610 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_250.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_610.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2021;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1736) : uint(this.const_1737);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_250.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
