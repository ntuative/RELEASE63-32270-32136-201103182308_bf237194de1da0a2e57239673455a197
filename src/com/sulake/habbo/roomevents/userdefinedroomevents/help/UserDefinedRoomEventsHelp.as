package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1863:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1863 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1201 = this.var_1863.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1201)
         {
            this.var_1201.procedure = this.onButtonClick;
         }
         this.var_1200 = this.var_1863.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1200)
         {
            this.var_1200.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_270 >= this.var_75.length - 1)
         {
            this.var_1200.disable();
         }
         else
         {
            this.var_1200.enable();
         }
         if(this.var_270 <= 0)
         {
      ...
      {
         ++this.var_270;
         this.var_270 = Math.min(this.var_270,this.var_75.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_75[this.var_270][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_75[this.var_270][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_75[this.var_270][1]).value;
