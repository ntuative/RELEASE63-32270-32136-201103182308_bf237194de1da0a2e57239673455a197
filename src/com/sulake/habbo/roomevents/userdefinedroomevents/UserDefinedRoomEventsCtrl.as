package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1514:int = 2;
      ...
      private var var_1972:TriggerConfs;
      
      private var var_1973:ActionTypes;
      
      private var var_1974:ConditionTypes;
      
      private var var_278:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_812:RoomObjectHightLighter;
      
      private var var_130:UserDefinedRoomEventsHelp;
      
      private var var_1253:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1972 = new TriggerConfs();
         this.var_1973 = new ActionTypes();
         this.var_1974 = new ConditionTypes();
         this.var_278 = new Dictionary();
         super();
         this.var_83 = param1;
         this.var_812 = new RoomObjectHightLighter(param1);
         this.var_130 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1253 = new SliderWindowController(this.var_83,IWindowContainer(this.find(this.var_53,"delay_slider_container")),this.var_83.assets,0,20,1);
         this.var_1253.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1253.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_812.hideAll(this.var_278);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_812.showAll(this.var_278);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1253.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1253.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_130.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1514) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1514 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1973);
         this.refreshConfigureElement(this.var_1974);
