package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2035:int = 16;
      
      private const const_1352:int = 4;
      
      private const const_2045:uint = 14342874;
      
      private const const_2041:uint = 3815994;
      
      private const const_2042:uint = 2085362;
      
      private const const_2039:uint = 39616;
      
      private const const_2036:uint = 10513106;
      
      private const const_2044:uint = 8734654;
      
      private const const_2043:uint = 9094430;
      
      private const const_2037:uint = 6200576;
      
      private const const_2046:String = "happiness";
      
      private const const_2040:String = "experience";
      
      private const const_2038:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2046,param1.nutrition,param1.nutritionMax,this.const_2039,this.const_2042);
         this.updateStateElement(this.const_2040,param1.experience,param1.experienceMax,this.const_2044,this.const_2036);
         this.updateStateElement(this.const_2038,param1.energy,param1.energyMax,this.const_2037,this.const_2043);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2047,this.const_2035,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2045);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2041);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_207 && this.var_207.getPetId() == this.var_499)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1631,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_490,this._widget.petData.ownerId);
