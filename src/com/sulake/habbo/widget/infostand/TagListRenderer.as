package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2025:int = 5;
      
      private const const_2026:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_165:Function;
      
      private var _offsetX:int;
      
      private var var_1144:int;
      
      private var var_1143:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1144 = 0;
         this.var_1143 = param2.rectangle.clone();
         this.var_1143.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1143.width)
         {
            return false;
         }
         if(this.var_1144 + param1.height > this.var_1143.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1143.width)
         {
            this._offsetX = 0;
            this.var_1144 += param1.height + this.const_2026;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1144);
         this._offsetX += param1.width + this.const_2025;
         return true;
      }
      ...
      private function createTag(param1:String) : ITextWindow
      {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_165);
