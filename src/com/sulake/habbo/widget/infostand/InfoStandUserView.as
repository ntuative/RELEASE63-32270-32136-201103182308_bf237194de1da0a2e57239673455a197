package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_169:IFrameWindow;
      
      private var var_646:IWindow;
      ...
      private const const_1760:int = 39;
      
      private const const_1759:int = 7829367;
      
      private const const_1758:int = 16777215;
      
      private const const_2051:int = 2000;
      ...
      {
         if(this.var_54 == null || this.var_206 == null || this.var_67 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_206.width,this.var_67.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_206.width < this.var_67.width)
         {
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1759;
            }
            else
            {
               _loc3_.textColor = this.const_1758;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_981;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_381,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_381,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function method_5(param1:int, param2:BitmapData) : void
      {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1150:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1095:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2613 > this.const_2051 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2613 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1759;
            if(_loc3_.length >= this.const_1760)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1760 - 1);
            }
         }
      }
      ...
      {
         this.var_169 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_169.center();
         this.var_169.procedure = this.badgesEventProc;
         this.var_169.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_169 && this.var_169.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_646 = null;
         var _loc2_:IItemGridWindow = this.var_169.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_169.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_169.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_646);
               }
               if(_loc3_ <= -1)
               {
                  return;
