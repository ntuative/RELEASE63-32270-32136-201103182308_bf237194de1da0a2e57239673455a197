package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView
   {
      ...
      public function InfoStandJukeboxView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_549 = param4;
         this.var_549.events.addEventListener(NowPlayingEvent.const_704,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_549)
         {
            this.var_549.events.removeEventListener(NowPlayingEvent.const_704,this.onNowPlayingChanged);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_903 = this.var_206.findChildByTag("catalog");
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var _loc2_:int = this.var_549.musicController.getRoomItemPlaylist().nowPlayingSongId;
         if(_loc2_ != -1)
         {
            _loc6_ = this.var_549.musicController.getSongInfo(_loc2_);
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_54.addListItem(this.var_903);
            }
            this.var_903.visible = param1;
         }
         else
         {
            this.var_54.removeListItem(this.var_903);
         }
      }
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this._widget.mainContainer.visible && this._window.visible)
         {
            if(param1.id != -1)
            {
               _loc2_ = this.var_549.musicController.getSongInfo(param1.id);
               if(_loc2_ != null)
               {
