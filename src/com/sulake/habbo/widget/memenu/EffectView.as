package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2029:int = 1000;
      ...
      {
         super();
         this.var_199 = new Timer(this.const_2029);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_186.isActive)
         {
            _loc2_ = this.var_186.secondsLeft / Number(this.var_186.duration);
            this.var_935.width = _loc2_ * this.var_306;
         }
         else
         {
            this.var_935.width = 0;
            this.var_199.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_751 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_751 == null)
            {
               return;
            }
         ...
         if(!this.var_186.isActive)
         {
            this.var_751.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_751.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_751.text;
         var _loc2_:int = this.var_186.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_186.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_186.isActive)
         {
         ...
         else
         {
            ...
            this.var_934 = this._window.findChildByName("effect_hilite");
            this.var_934.visible = false;
         }
         this.setTimeLeft();
         this.var_935 = this._window.findChildByName("loader_bar");
         if(this.var_935 != null)
         {
            this.var_306 = this.var_935.width;
            this.var_199.start();
            this.onUpdate();
         }
         if(this.var_186.icon)
         {
            this.setElementBitmap("effect_icon",this.var_186.icon);
         }
      }
