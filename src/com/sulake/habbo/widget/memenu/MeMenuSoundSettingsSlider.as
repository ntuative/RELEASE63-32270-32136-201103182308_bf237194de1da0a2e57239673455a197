package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_710 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_710.width,this.var_710.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_710,this.var_710.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_709 != null)
               {
                  ...
                  this.var_1676 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
