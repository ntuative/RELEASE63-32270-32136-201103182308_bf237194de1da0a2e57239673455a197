package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2862:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2862 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_385:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_75,this.var_154,this.var_2625++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_75,this.var_154,this);
               break;
            case RoomWidgetEnum.const_523:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_75,this.var_154,this._catalog,this.var_549);
               break;
            case RoomWidgetEnum.const_511:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_75,events,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_480:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_75,this.var_154,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_493:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_75,this.var_154);
               break;
            case RoomWidgetEnum.const_806:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_75,this.var_154);
               break;
            case RoomWidgetEnum.const_111:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_75,this.var_154);
               break;
