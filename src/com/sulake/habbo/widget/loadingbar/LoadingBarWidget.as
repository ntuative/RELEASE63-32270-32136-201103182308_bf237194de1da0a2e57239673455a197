package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_472:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_472.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_472 = null;
         }
         if(this.var_46 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_290,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_290,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_472 == null)
         {
            this.var_472 = new Sprite();
            this.var_472.addChild(new Bitmap(this.var_46));
            this.var_472.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_472.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_472);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_290)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1260 != "")
         {
            HabboWebTools.openWebPage(this.var_1260);
         }
      }
   }
}
