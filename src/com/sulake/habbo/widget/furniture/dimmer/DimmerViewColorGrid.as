package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_539.numGridItems)
         {
            return;
         }
         this.select(this.var_539.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this.var_17 == null || this.var_539 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_539.destroyGridItems();
         this.var_362 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_1946) as IWindowContainer;
            ...
            this.var_539.addGridItem(_loc3_);
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1240.width,this.var_1240.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1007.width,this.var_1007.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1007,this.var_1007.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_539.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1946 = XML(_loc2_.content);
         ...
         this.var_1240 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         this.var_1007 = BitmapData(_loc3_.content);
      }
