package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1773:int = 0;
      
      private const const_1775:int = 1;
      
      private const const_1772:int = 2;
      
      private const const_1776:int = 3;
      
      private const const_1777:int = 4;
      
      private const const_2057:int = 0;
      
      private const const_2062:int = 1;
      
      private const const_2061:int = 2;
      
      private const const_2063:int = 3;
      
      private const const_2060:int = 4;
      
      private const const_2059:int = 5;
      
      private const const_1774:String = "deco_img";
      
      private const const_1771:String = "dialog_bg";
      
      private const const_2064:String = "%campaign%_dialog_bg.png";
      
      private const const_336:String = "%campaign%_gift_package.png";
      
      private const const_2058:String = "%campaign%_gift_content.png";
      
      private const const_2056:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1522 = this.var_154.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1522 += "Viral/";
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_649,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_576:
               _loc2_ = this.const_1773;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_649:
               ...
               this._shareId = null;
               this.var_1523 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_886:
               _loc2_ = this.const_1775;
               this.var_386 = param1.objectId;
         ...
         if(this._window && (this.var_1521 != _loc2_ || _loc3_ != this.var_193))
         {
            this._window.dispose();
            this._window = null;
         }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1521)
            {
               case this.const_1773:
               ...
               case this.const_1775:
                  if(this.var_397 == this.const_2057)
                  {
                  ...
                  else if(this.var_397 == this.const_2062)
                  {
                     ...
                     _loc2_ = this.const_2058;
                  }
                  else if(this.var_397 == this.const_2061)
                  {
                  ...
                  else if(this.var_397 == this.const_2063)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_397 == this.const_2060)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_193,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_397 == this.const_2059)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2064.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc5_,this.const_1771);
            _loc2_ = _loc2_.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc2_,this.const_1774);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_815);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1523 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1523 == 1 ? "null" : InventoryCategory.const_138);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_636,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1524.push(new ImageDownloader(this,_assets,this.var_193,this.var_1522,param1,param2));
            return;
         }
