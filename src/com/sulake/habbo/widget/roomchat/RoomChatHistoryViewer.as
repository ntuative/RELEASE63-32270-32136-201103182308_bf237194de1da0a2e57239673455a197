package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1081,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!this.var_405 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_179.state == RoomChatHistoryPulldown.const_342 || this.var_179.state == RoomChatHistoryPulldown.const_500;
      }
      ...
      {
         if(!this.var_405 && !this.var_1942)
         {
            this.var_405 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_179.state = RoomChatHistoryPulldown.const_342;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_571;
            }
         }
         if(this.var_179 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_404 > 0 && param2)
         {
            if(this.var_1601)
            {
               if(Math.abs(param1 - this.var_404) <= const_1160)
               {
                  return;
               }
               this.var_1601 = false;
            ...
            if(this.var_405)
            {
               ...
               _loc5_ = (param1 - this.var_404) / this.var_49.height;
               _loc3_ = this.var_571 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_404;
               _loc7_ = true;
               _loc8_ = true;
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_571 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_571 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
