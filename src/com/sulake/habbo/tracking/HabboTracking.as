package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_920:uint = 11;
      ...
      private var var_196:IHabboFriendList;
      ...
      private var var_565:FramerateTracker = null;
      
      private var var_240:LatencyTracker = null;
      
      private var var_566:LagWarningLogger = null;
      
      private var var_564:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_565 = new FramerateTracker();
         this.var_240 = new LatencyTracker();
         this.var_566 = new LagWarningLogger();
         this.var_564 = new ToolbarClickTracker(this);
         this.var_1307 = new Array(const_920);
         var _loc4_:int = 0;
         while(_loc4_ < const_920)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1450,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1697,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1601,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_756,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1075,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_196)
            {
               if(!this.var_196.disposed)
               {
                  Component(this.var_196).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_196).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_196).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_196).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_196).events.removeEventListener(HabboFriendListTrackingEvent.const_365,this.onFriendlistTrackingEvent);
               }
               this.var_196.release(new IIDHabboFriendList());
               this.var_196 = null;
            }
            if(this.var_130)
            {
               if(!this.var_130.disposed)
               {
                  this.var_130.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_130.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_130.release(new IIDHabboHelp());
               this.var_130 = null;
            }
            if(this.var_188)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_178)
         {
            if(this.var_240 != null)
            {
               this.var_240.configuration = this.var_178;
            }
            if(this.var_241 != null)
            {
               this.var_241.configuration = this.var_178;
            }
            ...
            if(this.var_178)
            {
               ...
               {
                  this.var_566.configure(this.var_178);
               }
               if(this.var_565 != null)
               {
                  this.var_565.configure(this.var_178);
               }
               if(this.var_564 != null)
               {
                  this.var_564.configure(this.var_178);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_777,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_528,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_566 != null)
            {
               this.var_566.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_528)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1485);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1615);
               break;
            case HabboCommunicationEvent.const_777:
               this.trackLoginStep(HabboLoginTrackingStep.const_1464,String(this._communication.port));
               break;
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1211);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1211,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_196 = param2 as IHabboFriendList;
         Component(this.var_196).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_196).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_196).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_196).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_196).events.addEventListener(HabboFriendListTrackingEvent.const_365,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_365:
      ...
      {
         this.var_130 = param2 as IHabboHelp;
         this.var_130.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_130.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1075,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_756,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_243,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_295 = param2 as IAdManager;
         this.var_295.events.addEventListener(AdEvent.const_586,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_564)
         {
            this.var_564.track(param1.iconName);
         }
      }
      ...
      {
         this.var_566.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_469 > -1 && _loc2_ < this.var_469)
         {
            ++this.var_1572;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1572);
         }
         if(this.var_469 > -1 && _loc2_ - this.var_469 > 15000)
         {
            ++this.var_1571;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1571);
         }
         this.var_469 = _loc2_;
         if(this.var_241 != null)
         {
            this.var_241.update(param1,this.var_469);
         }
         if(this.var_240 != null)
         {
            this.var_240.update(param1,this.var_469);
         }
         if(this.var_565 != null)
         {
            this.var_565.trackUpdate(param1,this,this.var_469);
         }
         if(this.var_566 != null)
         {
            this.var_566.update(this.var_469);
         }
      }
   }
}
