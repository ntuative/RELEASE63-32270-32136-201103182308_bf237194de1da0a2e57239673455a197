package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this.var_17 != null)
         {
            this.var_239 = this.var_17.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_239.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_239.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_239.autoArrangeItems = false;
            this.var_239.lock();
         }
         else
         {
            this.var_239.autoArrangeItems = true;
            this.var_239.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN)
         {
            ...
            this.var_68.toggleItemSelection(this._category,this.var_239.getGridItemIndex(param1.window));
            this.var_561 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_561 != null && this.var_561 == param2 && !this.var_68.isTradingOpen)
         {
