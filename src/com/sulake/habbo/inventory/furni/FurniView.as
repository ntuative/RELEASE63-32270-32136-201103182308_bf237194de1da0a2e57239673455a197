package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2066:int = 0;
      
      private const const_934:int = 1;
      
      private const const_1756:int = 2;
      
      private const const_1755:int = 3;
      
      private const const_1778:int = 42;
      ...
      private var var_714:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_549 = param6;
         this.var_549.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
         this.var_459 = new Map();
         this.var_459.add(FurniModel.const_45,new FurniGridView(this.var_68,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_459.add(FurniModel.const_50,new FurniGridView(this.var_68,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_549)
            {
               this.var_549.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
               this.var_549 = null;
            }
            this.var_674 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_459.getValue(this.var_458);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_458);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_934;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1756;
         }
         else
         {
            _loc2_ = this.const_1755;
         }
         if(this.var_2462 == _loc2_)
         {
            return;
         }
         this.var_2462 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_934:
               ...
               break;
            case this.const_1756:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1755:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_458);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_400)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_160)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_714 && this.var_714.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1079)
               {
                  _loc21_ = this.var_549.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_549.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_674.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1079)
               {
                  _loc22_ = this.var_549.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         else if(_loc3_ < this.const_1778)
         {
            _loc3_ = this.const_1778;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_61)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_401);
            }
         }
      }
      ...
      {
         if(this.var_674.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_674.indexOf(param1.id as Number) != -1)
            {
               this.var_674.splice(this.var_674.indexOf(param1.id as Number),1);
            }
         }
      }
   }
