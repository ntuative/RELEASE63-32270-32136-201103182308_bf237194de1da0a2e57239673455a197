package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_401:String = "pets";
      
      private static const const_1308:int = 100;
      ...
      private var var_1723:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_242,this.onObjectPlaced);
         this._catalog = param7;
         this.var_549 = param8;
         this.var_604 = new Timer(const_1308,1);
         this.var_604.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2368 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_549);
         this.var_17.switchCategory(const_45);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_242,this.onObjectPlaced);
               }
            ...
            {
               this.var_604.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_604.stop();
               this.var_604 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1723 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1723;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_400)
         {
         ...
         if(this.var_904 == null)
         {
            this.var_904 = this._windowManager.buildFromXML(this.var_2368) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_904.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_75 && this._controller.isVisible)
         {
            switch(this.var_17.visibleCategoryId)
            {
               ...
               case const_50:
                  ...
                  break;
               case const_401:
                  this._controller.toggleInventoryPage(InventoryCategory.const_138);
            }
         }
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_605.add(const_45,new Array());
         this.var_605.add(const_50,new Array());
         if(this.var_17 != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_160)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_316;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_338 || _loc3_.category == FurniCategory.const_358 || _loc3_.category == FurniCategory.const_400)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1388 && param1.type == RoomEngineObjectEvent.const_242)
         {
            this.var_1388 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_605.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_822)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
