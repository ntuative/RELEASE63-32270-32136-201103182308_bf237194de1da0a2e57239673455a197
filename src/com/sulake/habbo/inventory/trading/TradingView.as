package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_937:uint = 4284532064;
      
      private static const const_938:uint = 2577770;
      ...
      private var var_417:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_417 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1685 = this.createMinimizedWindow();
         }
         if(!this.var_2285)
         {
            return this.var_69;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_69)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_937) : uint(const_938);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_937) : uint(const_938);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_160)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1242)
            {
            ...
            this.var_417.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_495);
            this.var_417.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_417.hideDelayed();
         }
      }
