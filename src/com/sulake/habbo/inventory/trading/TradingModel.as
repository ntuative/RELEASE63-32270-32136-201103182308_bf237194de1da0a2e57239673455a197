package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1521:uint = 9;
      ...
      public static const const_508:uint = 4;
      
      public static const const_264:uint = 5;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager)
      {
         ...
         this.var_57 = new TradingView(this,param2,param4,param5,param6);
      }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_57.updateItemList(this.var_753);
         this.var_57.updateItemList(this.var_1412);
      ...
      public function close() : void
      {
         if(this.var_777)
         {
            if(this._state != const_200 && this._state != const_264)
            {
      ...
      {
         this.var_57.setMinimized(param1 != InventoryCategory.const_75);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_752 + " OTHER: " + this.var_1157);
         ...
         {
            case const_200:
               if(param1 == const_201 || param1 == const_264)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_57.alertPopup(TradingView.const_1090);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_753)
            {
               this.var_752 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_753)
            {
               this.var_57.alertPopup(TradingView.const_1076);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_255.length < const_1521)
         {
