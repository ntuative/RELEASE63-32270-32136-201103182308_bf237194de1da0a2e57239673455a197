package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_188 != null && this.var_1166)
         {
            this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1166 = false;
         }
         this._controller.inventoryViewOpened(this.var_760);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_761 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_188 != null && this.var_1166)
            {
               this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1166 = false;
            }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1793);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_761 == InventoryCategory.const_138)
            {
               this.toggleCategoryView(InventoryCategory.const_138);
            }
            else if(this.var_761 == InventoryCategory.const_75)
            {
