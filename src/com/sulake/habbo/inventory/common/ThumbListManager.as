package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1480:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_93 = this.var_652.height;
         this.var_1216 = param5;
         this.var_984 = param6;
         this.var_228 = Math.floor(this.var_1216 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1216,this.var_984);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_653 = this.resolveRowCountFromList();
         if(this.var_653 == 0)
         {
            this.var_26 = new BitmapData(this.var_1216,this.var_984);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_228 * this._thumbWidth,this.var_1216),Math.max(this.var_653 * this.var_93,this.var_984),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_653)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_228)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_228 && this.var_26.height < _loc3_.y * this.var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_228 - 1),this.var_93);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_228 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_93),null,null,true);
         _loc4_ = new Rectangle(0,this.var_93,this._thumbWidth * (this.var_228 - 1),this.var_26.height - this.var_93);
      ...
      {
         var _loc1_:* = null;
         if(this.var_1480 != null)
         {
            _loc1_ = this.var_1480.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_228));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_228 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_228);
         var _loc3_:int = param1 % this.var_228;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_228)
         {
            return;
         }
         if(param1.y >= this.var_653)
         {
            return;
         }
         var _loc4_:int = this.var_228 - param1.x - 1;
         ...
         if(this.var_26.height < this.var_984)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_984);
