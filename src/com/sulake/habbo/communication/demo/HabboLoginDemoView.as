package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_486:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_162.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_139,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1735,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_162.habboConfiguration.getKey("use.sso","HabboRoomWidgetLib_user_tag_highlighted") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1735,"/");
         ...
         {
            dispatchEvent(new Event(const_486));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_135.removeEventListener(SSOTicket.const_411,this.onParsedTicketSuccess);
            this.var_135.removeEventListener(SSOTicket.const_283,this.onParsedTicketFailure);
            this.var_135 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_135 = new SSOTicket(this.var_162.assets,_loc3_,_loc2_,param1);
         this.var_135.addEventListener(SSOTicket.const_411,this.onParsedTicketSuccess);
         this.var_135.addEventListener(SSOTicket.const_283,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_162.shockwaveClientUrl = this.var_135.shockwaveClientUrl;
         this.var_162.ssoTicket = this.var_135.ticket;
         this.var_135.removeEventListener(SSOTicket.const_411,this.onParsedTicketSuccess);
         this.var_135.removeEventListener(SSOTicket.const_283,this.onParsedTicketFailure);
         this.var_135 = null;
         dispatchEvent(new Event(const_486));
