package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_216:HabboHotelView;
      
      private var var_1325:String = "";
      
      private const const_1735:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_576 = param1;
            this.var_56.initConnection(HabboConnectionType.const_229);
         }
      }
      ...
      {
         if(this.var_56 && this.var_154 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_216 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_154.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_154.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_216.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_154.getKey("use.sso.ticket") == "1";
         this.var_576 = this.var_154.getKey("sso.ticket",null);
         this.var_1616 = this.var_154.getKey("flash.client.url","");
         this.var_2185 = this.var_154.getKey("external.variables.txt","");
         if(this.var_216 == null)
         {
            this.var_216 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_56.mode = HabboConnectionType.const_89;
            if(this.var_576)
            {
               this.var_56.initConnection(HabboConnectionType.const_229);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_17.addEventListener(HabboLoginDemoView.const_486,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1228;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_229);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_777);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2186 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_89:
               ...
               this.var_216.loadBannerImage(_loc7_ + "?token=" + this.var_1325,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1228:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1489:
               this.var_863 = this.generateRandomHexString(30);
               this.var_476 = new DiffieHellman(new BigInteger(this.var_154.getKey("connection.development.prime"),16),new BigInteger(this.var_154.getKey("connection.development.generator"),16));
               this.var_476.init(this.var_863);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2186);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1326 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_239);
         connection.send(new VersionCheckMessageComposer(401,this.var_1616,this.var_2185));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1735,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2187)
         {
