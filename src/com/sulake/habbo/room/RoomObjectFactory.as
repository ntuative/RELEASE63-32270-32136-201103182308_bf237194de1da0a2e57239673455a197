   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      public function addObjectEventListener(param1:Function) : void
      {
         ...
         if(this.var_928.indexOf(param1) < 0)
         {
            ...
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1152.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_928.indexOf(param1);
         if(_loc3_ >= 0)
         {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1152.getValue(param1) == null)
         {
            this.var_1152.add(param1,true);
            for each(_loc2_ in this.var_928)
            {
               if(_loc2_ != null)
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1769.getValue(param1) == null)
            {
               this.var_1769.add(param1,true);
