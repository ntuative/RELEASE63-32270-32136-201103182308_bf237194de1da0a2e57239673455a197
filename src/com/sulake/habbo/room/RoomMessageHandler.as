package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1454:int = -1.0E9;
      
      private var var_772:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_772 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_772.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_772.objectData);
            this.var_772.objectData = null;
         }
         else
         {
            this.var_772.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_772.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_772.objectData = _loc6_;
         }
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.webID == this.var_2582)
               {
                  this.var_12.setOwnUserId(_loc4_,_loc5_,_loc7_.id);
               }
               _loc11_ = new RoomObjectAvatarFigureUpdateMessage(_loc7_.figure,_loc7_.sex,_loc7_.method_4);
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_890);
         var _loc8_:int = 0;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1091:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1213:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1054,_loc3_.status);
         }
      }
