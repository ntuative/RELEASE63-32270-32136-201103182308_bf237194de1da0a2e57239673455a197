package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2722:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1743 = _loc2_;
            this.var_2722 = param1.extra;
            this.var_1235 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1235 > 0 && param1 >= this.var_1235)
         {
            this.var_1235 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1743,String(this.var_1743),this.var_2722);
