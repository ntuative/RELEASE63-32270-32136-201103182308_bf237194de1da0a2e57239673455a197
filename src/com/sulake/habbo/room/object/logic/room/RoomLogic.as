package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1803:int = 255;
      
      private var var_1477:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_496,RoomObjectMouseEvent.const_142];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1129,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_653,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_764,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_624,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_856,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1214)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1803;
            if(_loc2_ - this.var_1214 >= this.var_1887)
            {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_653,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_887:
               param2.setString(RoomObjectVariableEnum.const_849,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_693:
               param2.setString(RoomObjectVariableEnum.const_906,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_724:
               param2.setString(RoomObjectVariableEnum.const_680,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_475:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_231)
               {
                  _loc5_ = "null";
               }
               this.var_537.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_869:
               _loc4_ = this.var_537.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_537.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1189,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1216:
               param2.setNumber(RoomObjectVariableEnum.const_764,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1200:
               param2.setNumber(RoomObjectVariableEnum.const_624,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_856,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1232,int(param1.bgOnly));
         this.var_1477 = this._color;
         this.var_1886 = this.var_1803;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_453,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1478,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1451,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1686,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_453,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_170 || _loc12_ == RoomPlaneData.const_319)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
