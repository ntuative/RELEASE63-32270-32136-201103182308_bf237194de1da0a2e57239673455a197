package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1730:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2790:Number = NaN;
      ...
      private var var_2791:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1526 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1526;
            this.var_1526 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_609 != spriteCount)
         {
            createSprites(this.var_609);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2546;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_461 != _loc3_.getUpdateID() || param1 != var_101 || param2 != this.var_2790)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2789 = _loc3_.getNumber(RoomObjectVariableEnum.const_227);
            ...
            this.var_1260 = _loc3_.getString(RoomObjectVariableEnum.const_350);
            if(this.var_1260 == null || this.var_1260.indexOf("http") != 0)
            {
               this.var_1260 = null;
            }
            this.var_2546 = this.var_1260 != null;
      ...
      {
         if(this.var_2787 != param2 || this.var_2791 != param1)
         {
            this.var_1025 = [];
            this.var_1026 = [];
            this.var_820 = [];
            ...
            this.var_2788 = this.getSize(param1);
      ...
      {
         this.var_609 = param1;
         this.var_1982 = this.var_609 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_578.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1025[param2];
         var _loc4_:Boolean = this.var_1026[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2788;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1982)
            {
               _loc6_ = FurnitureVisualizationData.const_578[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1025[param2] = _loc3_;
            this.var_1026[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_819[param3] != null && !this.var_1983)
         {
      ...
      {
         if(this.var_825[param2] != null)
         {
            return this.var_825[param2];
         }
         if(this._data == null)
         {
