package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1276:int = 3;
      ...
      {
         return param1 + param2 * const_1276;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_144,const_74,const_68,const_144,const_74,const_68];
                     _loc8_ = [const_74,const_74,const_74,const_68,const_68,const_68];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
