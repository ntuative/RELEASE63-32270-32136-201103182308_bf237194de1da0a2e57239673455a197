package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1716:String = "cone";
      
      public static const const_1532:String = "plane";
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_279 = param6;
         this.var_2775 = param7;
         this.var_2779 = param9;
         this._energy = param8;
         this.var_2776 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1020 = 0;
         this.var_982 = false;
         this.init(0,0,0,this._direction,this.var_2780,this.var_1019,this.var_2779,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1255.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_982 = true;
         if(this.var_1020 < this.var_1516)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2778)
         {
            switch(this.var_2775)
            {
               case const_1716:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1255.length);
         return this.var_1255[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1020 < this.var_1516)
         {
            if(this.age % this.var_2776 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1020 < this.var_1516)
         {
            ...
            this.y = (2 - this.var_279) * this.y - (1 - this.var_279) * this.lastY + this.var_1978 * this.var_1019 * this.var_1019;
         ...
         for each(_loc2_ in this.var_388)
         {
            ...
            _loc2_.y = (2 - this.var_279) * _loc2_.y - (1 - this.var_279) * _loc2_.lastY + this.var_1978 * this.var_1019 * this.var_1019;
