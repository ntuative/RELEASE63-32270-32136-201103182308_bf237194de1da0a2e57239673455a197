package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1975:XMLList;
      
      private var _offsetX:int;
      
      private var var_1144:int;
      
      private var var_2473:Vector3d;
      ...
      private var var_1156:Point = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_933)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1410 = this.var_44.getValue(this.var_933);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2473 = new Vector3d(-0.5,0.5,0);
         this.var_932 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2473);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1156.x = _loc3_.x;
         this.var_1156.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_933);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1780 = RoomObjectVariableEnum.const_1012;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1780 = RoomObjectVariableEnum.const_1065;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1155 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1155 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_933);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2475 && param3 == this.var_2474)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1155 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1155 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1780);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1156.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1156.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_429.indexOf(_loc10_) >= 0 && this.var_932)
            {
               param1 = this.var_429.indexOf(_loc10_);
               if(this.var_621[param1] != "")
               {
                  _loc9_ = this.var_721.getAsset(this.var_621[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_620[param1] != -1)
               {
                  param2.alpha = this.var_620[param1];
               }
               this.var_429.splice(param1,1);
      ...
      {
         this.var_932 = true;
         var _loc3_:int = this.var_429.indexOf(param1);
         if(_loc3_ < 0)
         {
