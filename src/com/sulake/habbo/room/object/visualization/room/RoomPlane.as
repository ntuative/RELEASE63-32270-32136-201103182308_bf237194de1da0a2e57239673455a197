package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_890:IPlaneRasterizer = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2312 = param9;
         this.var_2313 = param10;
         this.var_2315 = param11;
      ...
      {
         return this._isVisible && this.var_716;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_600);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_890.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_716 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_344))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_890 != null)
            {
               _loc3_ = this.var_890.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1692,this.var_2312,this.var_2313,this.var_2315,this.var_2316,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1588 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_716)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1373.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1373[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1053);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_151.z - originZ,this.var_112.z - originZ,this.var_85.z - originZ,this.var_113.z - originZ);
            ...
            this.var_1588 = geometry.updateId;
         }
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_247.length == this.var_892.length)
         {
            while(_loc1_ < this.var_247.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_892[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_345.length > this.var_1374.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_891 || this.var_247.length == 0 && this.var_345.length == 0 && !this.var_344 || this.var_726 == null)
         {
            return;
         }
         ...
         if(this.var_344)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_568);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_247.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc3_.leftSideLoc / this.var_290.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_289.length;
                  _loc12_ = _loc3_.type;
                  this.var_726.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_892.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_345.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_290.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_289.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_290.length;
                  ...
                  this.var_1374.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_344 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_219.copyChannel(param1,param1.rect,const_600,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_219.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_219,this.var_219.rect,const_600,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
