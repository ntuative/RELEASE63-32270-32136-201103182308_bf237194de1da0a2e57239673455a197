package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1627:int = 16777215;
      
      public static const const_1642:int = 13421772;
      
      private static const const_997:int = 16777215;
      
      private static const const_996:int = 13421772;
      
      private static const const_994:int = 10066329;
      
      private static const const_995:int = 10066329;
      
      public static const const_1588:int = 16777215;
      
      public static const const_1640:int = 13421772;
      
      public static const const_1533:int = 10066329;
      ...
      private var var_537:RoomPlaneBitmapMaskParser = null;
      
      private var var_1765:String = null;
      
      private var _floorType:String = null;
      
      private var var_1763:String = null;
      
      private var var_2717:String = null;
      
      private var var_1234:uint = 16777215;
      
      private var var_2719:int = 255;
      
      private var var_2720:int = 255;
      
      private var var_2718:int = 255;
      ...
      private const const_2055:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_537 = new RoomPlaneBitmapMaskParser();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_136 != null)
         {
            ...
            {
               _loc4_ = this.var_136[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_136.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_136[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1129);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1163);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_202)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_170)
            {
               ...
               {
                  _loc13_.color = const_997;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_996;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_319)
            {
               ...
               {
                  _loc13_.color = const_1640;
               }
               else
               {
                  _loc13_.color = const_1533;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1508)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_117,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         _loc9_ = param2;
         if(_loc9_ < this.var_1772 + this.const_2055 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_382.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1941)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2718 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2720 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2719 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1588)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1316 || _loc3_.y != this.var_2126 || _loc3_.z != this.var_2127 || param1.scale != this.var_2124))
            {
               this.var_1316 = _loc3_.x;
               this.var_2126 = _loc3_.y;
               this.var_2127 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1189);
            if(_loc3_ != this.var_2717)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2717 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_653));
            if(_loc4_ != this.var_1234)
            {
               this.var_1234 = _loc4_;
               this.var_2718 = this.var_1234 & 255;
               this.var_2720 = this.var_1234 >> 8 & 255;
               this.var_2719 = this.var_1234 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1232));
            if(_loc5_ != this.var_1941)
            {
               this.var_1941 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_176 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_906);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_849);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_680);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_764));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_624));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_856));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_136[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1937;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_537.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_136.length)
         {
            _loc3_ = this.var_136[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_537.maskCount)
         {
            _loc10_ = this.var_537.getMaskType(_loc8_);
            _loc11_ = this.var_537.getMaskLocation(_loc8_);
            _loc12_ = this.var_537.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_136.length)
               {
                  _loc3_ = this.var_136[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_117 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_231)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_136[_loc18_] as RoomPlane;
