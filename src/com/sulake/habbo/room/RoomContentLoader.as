package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_637:String = "RCL_LOADER_READY";
      
      private static const const_328:String = "RCL_PUBLICROOM_";
      
      private static const const_1743:int = 0;
      
      private static const const_934:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_417:String = "place_holder";
      
      private static const const_598:String = "wall_place_holder";
      
      private static const const_597:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_417;
      
      private static const const_596:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_933:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2250 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_934)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2248 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2251 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2249 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_707.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_413.add(_loc3_,_loc4_);
               if(this.var_341[_loc7_] == null)
               {
                  this.var_341[_loc7_] = 1;
               }
            }
            ...
            _loc8_ = this.var_589.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_589.remove(_loc7_);
               this.var_589.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2247)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_637));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_483 != null)
         {
            this.var_483.remove(param1);
            this.var_483.add(param1,param2);
         }
         if(this.var_484 != null)
         {
            this.var_484.remove(param2);
            this.var_484.add(param2,param1);
         }
      }
      ...
      {
         return [const_417,const_598,const_597,const_596,TILE_CURSOR,const_933];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_413.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_590.getValue(param1) as String;
      ...
      {
         if(this.var_707.getValue(param1) != null)
         {
      ...
      {
         if(this.var_198 != null && this.var_198.hasWorldType(const_328 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_255 || param1 == RoomObjectVisualizationEnum.const_67 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_32 || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_589.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2249 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_32:
                     if(this.var_341[_loc4_] == null)
                     {
                        this.var_341[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1358.getValue(param1) != null)
         {
            this.var_198 = this.var_1358.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_631,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2250.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1473);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_414[_loc5_] != null)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_577,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1358.add(param1,_loc4_);
         this.var_198 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_706.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_706.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_706.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_524.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_328 + param1) == RoomObjectCategoryEnum.const_73)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_198.getWorldHeightScale(const_328 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_198 != null)
         {
            return this.var_198.getWorldScale(const_328 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_413.remove(param1);
         this.var_413.add(param1,param2);
      }
   }
}
