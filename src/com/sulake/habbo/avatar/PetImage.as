package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_275:AvatarImageCache;
      ...
      private var var_554:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1361);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_630);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_630);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_630);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_630);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_341:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1703:
                  case AvatarAction.const_1635:
                  case AvatarAction.const_1452:
                  case AvatarAction.const_1045:
                  case AvatarAction.const_1194:
                  case AvatarAction.const_1523:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_882);
         this.getCache().resetBodyPartCache(this.var_882);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1363 = this._structure.sortActions(this.var_330);
         ...
         {
            this.var_740 = this._structure.getCanvasOffsets(this.var_1363,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1363)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_228)
               {
                  this.var_883 = true;
               }
