package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureData implements IAvatarImageListener
   {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.setDirection(AvatarSetType.const_36,int(const_771));
