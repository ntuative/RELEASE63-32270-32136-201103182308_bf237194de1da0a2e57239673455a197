package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1281:int = 2;
      ...
      protected var var_275:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_554:IAvatarDataContainer;
      ...
      protected var var_1292:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_275 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1280,const_1281);
         this.var_330 = new Array();
         this.var_882 = new ActiveActionData(AvatarAction.const_357);
         this.var_882.definition = this._structure.getActionDefinition(const_1282);
         this.resetActions();
      ...
      {
         param2 += this.var_1675;
         if(param2 < AvatarDirectionAngle.const_1202)
         {
            param2 = AvatarDirectionAngle.const_318 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_318)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_630,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_261.length == 1 && this.var_89 == this.var_1791)
         {
            return this.var_89 + this.var_516 + this.var_630 % 4;
         }
         if(this.var_261.length == 2)
         {
            for each(_loc1_ in this.var_261)
            {
               ...
               {
                  _loc2_ = this.var_630 % 11;
                  return this.var_89 + "_" + this.var_1791 + this.var_516 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2506 || param2 != this.var_2507 || param1 != this.var_2508)
         {
            this.var_2506 = param3;
            this.var_2507 = param2;
            this.var_2508 = param1;
            this.var_1796 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1292 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1292)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_630);
         ...
         {
            if(this.var_554.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_554.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_630);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_330.push(new ActiveActionData(param1,param2,this.var_630));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_286 = this.var_882;
         this.var_286.definition = this.var_882.definition;
         this.resetBodyPartCache(this.var_882);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_516 = "";
         this.var_261 = this._structure.sortActions(this.var_330);
         if(this.var_261 == null)
         {
            this.var_740 = new Array(0,0,0);
            if(this.var_1432 != "")
            {
               _loc1_ = true;
               this.var_1432 = "";
         ...
         {
            this.var_740 = this._structure.getCanvasOffsets(this.var_261,this._scale,this.var_89);
            ...
            if(this.var_1432 != this.var_516)
            {
               _loc1_ = true;
               this.var_1432 = this.var_516;
            }
         }
         this.var_1362 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_261)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_883 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1675 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_554 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_323 || _loc1_.actionType == AvatarAction.const_228 || _loc1_.actionType == AvatarAction.const_367)
               {
                  this.var_883 = true;
               }
            }
