package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1280:IWindowContainer;
      
      public static var var_1546:IWindowContainer;
      
      public static var var_2041:int = 6710886;
      ...
      private var var_530:ITabSelectorWindow;
      ...
      private var var_2616:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1203 = [];
         this.var_1468 = [AvatarEditorFigureCategory.const_781,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_261,AvatarEditorFigureCategory.const_761,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_104];
         super();
         ...
         if(var_1280 == null)
         {
            ...
            var_1280 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1546 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1546 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_439 = new Timer(1000);
         this.var_439.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_439.stop();
            this.var_439.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_439 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2616 = this.canChangeOutfit();
            this.var_439.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_530 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_530.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_530.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1203.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_530.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_530.numSelectables)
               {
                  this.var_530.getSelectableAt(_loc6_).x = this.var_530.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1867 == AvatarEditorSideCategory.const_104 || this.var_2615))
         {
      ...
      {
         if(this.var_1867 == AvatarEditorSideCategory.const_104)
         {
            this.var_2615 = false;
            this.setSideContent(AvatarEditorSideCategory.const_762);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_762:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_361 = param1;
         this.var_530.setSelected(this.var_530.getSelectableByName(param1));
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2614 = new Date().valueOf();
                  this.var_2616 = false;
                  this.var_439.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_529)
         {
            ...
            this.var_529 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_529.procedure = this.stripClubDialogEventProc;
            this.var_529.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2614 > 5000;
      }
   }
}
