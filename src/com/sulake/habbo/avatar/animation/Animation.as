package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1811:AvatarDataContainer;
      
      private var var_1438:Array;
      
      private var var_1812:DirectionDataContainer;
      
      private var var_1813:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1677 = String(param2.@desc);
         }
         else
         {
            this.var_1677 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1436.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1811 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1438.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1812 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1813 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1437.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_765.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.const_2008)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@const_2008;
               this.var_632.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_632.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            {
               for each(_loc5_ in this.var_765)
               {
      ...
      {
         return this.var_1436 != null;
      }
      
      public function hasAvatarData() : Boolean
      {
         return this.var_1811 != null;
      }
      ...
      public function get method_12() : ShadowDataContainer
      {
