package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1908:Number = 1.0;
      ...
      {
         super();
         this.var_1860 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2603 = parseInt(_loc2_,16);
         this.var_2602 = parseInt(_loc3_,16);
         ...
         this.var_948 = new ColorTransform(this.var_1907,this.var_1908,this.var_1906,this._alphaMultiplier);
         this.var_1195 = this.generatePaletteMapForGrayscale(this.var_2602,this.var_2603);
      }
