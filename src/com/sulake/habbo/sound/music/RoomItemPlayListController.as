package com.sulake.habbo.sound.music
{
   ...
   public class RoomItemPlayListController implements IPlayListController, IDisposable
   {
      ...
      private var var_474:HabboMusicController;
      ...
      public function RoomItemPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_893,this.onSongFinishedPlayingEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_695,this.onSoundMachinePlayEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_670,this.onSoundMachineStopEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_831,this.onJukeboxStopEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_428,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_893,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_695,this.onSoundMachinePlayEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_670,this.onSoundMachineStopEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_831,this.onJukeboxStopEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_428,this.onDisposeEvent);
               this.var_83 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_335);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_474.requestSongInfo(_loc2_.id);
            }
         }
      }
      ...
      {
         this.var_474.stop(HabboMusicPrioritiesEnum.PRIORITY_ROOM_PLAYLIST);
         this.var_335 = -1;
         this.var_691 = false;
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_474.getSongObject(this.var_335);
         if(_loc2_ != null)
         {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_474.playSong(param1,this.priority,_loc3_))
         {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_474.playSong(_loc3_.currentSongId,this.priority,_loc3_.syncCount / 1000);
            this.var_335 = _loc3_.currentSongId;
         }
         if(_loc3_.nextSongId >= 0)
         {
            this.var_474.requestSongInfo(_loc3_.nextSongId);
         }
         this.var_691 = true;
         this.var_549.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_704,_loc3_.currentSongId));
