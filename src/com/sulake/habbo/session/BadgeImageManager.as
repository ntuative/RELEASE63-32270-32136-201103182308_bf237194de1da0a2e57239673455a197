package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1173:String = "group_badge";
      
      public static const const_1491:String = "normal_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1491:
               ...
               {
                  _loc5_ = this.var_178.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1173:
               if(this.var_178 != null)
               {
                  if(this.var_178 != null)
                  {
                     _loc5_ = this.var_178.getKey("group.badge.url");
