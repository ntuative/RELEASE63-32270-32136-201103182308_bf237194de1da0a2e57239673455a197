package com.sulake.habbo.session
{
   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         var _loc2_:HabboGroupDetails = this._sessionManager.method_1(param1);
         if(_loc2_ == null)
         {
            return;
         }
         if(this.var_159 == null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_159 = this._sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_139,HabboWindowStyle.const_31,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
      ...
      private function onGroupDetailsEvents(param1:Event) : void
      {
         ...
         var _loc3_:HabboGroupDetails = this._sessionManager.method_1(this.var_2339);
         switch(_loc2_.name)
         {
