package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1742:String = "noconvinfo";
      
      private static const const_1741:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1352:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1352 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1018 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_265 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1352.prepare(this.var_1018);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1085,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1221,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_692,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_692,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1353 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1353.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1663 == -1 ? 0 : int(this.var_16.height - this.var_1663);
         var _loc4_:int = this.var_1662 == -1 ? 0 : int(this.var_16.width - this.var_1662);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_265.y = Util.getLowestPoint(this.var_16.content);
         this.var_265.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1206,this._friendList.tabs.findSelectedTab() != null);
         ...
         this.var_1663 = this.var_16.height;
         this.var_1662 = this.var_16.width;
