package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1763:String = "no_reqs_info";
      ...
      private var var_1890:IContainerButtonWindow;
      ...
      {
         this.var_1891 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1890 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1890.procedure = this.onDismissAllButtonClick;
         this.var_1891.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_165)
         {
         ...
         else if(param1.state == FriendRequest.const_1175)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_340 && _loc4_.state != FriendRequest.const_371)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1890,_loc1_);
      }
