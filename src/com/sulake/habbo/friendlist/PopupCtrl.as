package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_55 == null)
         {
            this.var_55 = IWindowContainer(this._friendList.getXmlWindow(this.var_1036));
         ...
         this.var_55.x = _loc4_.x - _loc3_.x + this.var_2079 + param2.width;
