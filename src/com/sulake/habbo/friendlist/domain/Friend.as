package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1897:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_983 = param1.gender;
         this.var_686 = param1.online;
         this.var_1717 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1575 = param1.motto;
         this.var_1574 = param1.lastAccess;
         this.var_1415 = param1.categoryId;
         this.var_1573 = param1.realName;
