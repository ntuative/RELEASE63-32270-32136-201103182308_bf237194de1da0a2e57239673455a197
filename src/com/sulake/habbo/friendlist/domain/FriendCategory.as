package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_375:int = 100;
      ...
      {
         if(this.var_906 >= this.getPageCount())
         {
            this.var_906 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_221.length / const_375);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_906 * const_375;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_906 + 1) * const_375,this.var_221.length);
      }
