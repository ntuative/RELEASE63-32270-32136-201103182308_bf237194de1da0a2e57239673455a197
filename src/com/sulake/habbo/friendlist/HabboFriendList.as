package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_696:ISessionDataManager;
      
      private var var_2191:FriendListLookAndFeel;
      
      private var var_456:FriendListTabs;
      
      private var var_17:FriendListView;
      
      private var var_1620:OpenedToWebPopup;
      
      private var var_2192:int;
      
      var var_102:FriendCategories;
      
      private var var_337:FriendRequests;
      
      private var var_1619:AvatarSearchResults;
      
      private var var_188:IHabboToolbar;
      
      private var var_857:IHabboNotifications;
      
      private var var_577:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2191 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_102 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1619 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_577.stop();
            this.var_577.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_577 = null;
         }
         ...
         if(this.var_857)
         {
            this.var_857.release(new IIDHabboNotifications());
            this.var_857 = null;
         }
         if(this.var_188)
         {
         ...
         if(this.var_696)
         {
            this.var_696.release(new IIDSessionDataManager());
            this.var_696 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1620 = new OpenedToWebPopup(this);
         }
         this.var_1620.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_337.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_311,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1066.createAvatarImage(param1,AvatarScaleType.const_91,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_178.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_178.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_857 = param2 as IHabboNotifications;
      ...
      {
         this.var_696 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_337 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_102.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1128,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_379,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_577)
         {
            this.var_577 = new Timer(120000);
            this.var_577.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_577.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_379);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_365));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_337.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_337.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_456.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_337.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_456.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1619.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_456.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_696 || !this.var_337)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_696.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_337.vipLimit;
         }
         else if(this.var_696.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_337.clubLimit;
         }
         if(_loc2_ > this.var_337.limit)
         {
            this.var_337.limit = _loc2_;
         }
      }
