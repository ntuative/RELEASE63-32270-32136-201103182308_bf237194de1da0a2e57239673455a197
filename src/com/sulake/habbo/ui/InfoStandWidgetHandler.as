package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_150,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_150,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_672.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_672.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_406);
         _loc1_.push(RoomWidgetUserActionMessage.const_672);
         _loc1_.push(RoomWidgetUserActionMessage.const_850);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_918);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_198);
         _loc1_.push(RoomWidgetFurniActionMessage.const_560);
         _loc1_.push(RoomWidgetFurniActionMessage.const_567);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_678);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_888);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_796);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1620);
         _loc1_.push(RoomWidgetPetCommandMessage.const_547);
         _loc1_.push(RoomWidgetPetCommandMessage.const_864);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_525)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_403 || param1.type == RoomWidgetUserActionMessage.const_584 || param1.type == RoomWidgetUserActionMessage.const_450)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_406:
            ...
            case RoomWidgetUserActionMessage.const_672:
               ...
               break;
            case RoomWidgetUserActionMessage.const_850:
            ...
            case RoomWidgetUserActionMessage.const_644:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1006,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_686:
               ...
               break;
            case RoomWidgetUserActionMessage.const_918:
            ...
            case RoomWidgetRoomTagSearchMessage.const_678:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_888:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_796:
            ...
            case RoomWidgetUserActionMessage.const_663:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_864:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_295);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_513) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_513);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_390);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1148);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1235);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_188)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_175)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_660)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_516);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_122)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_132)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_662);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1150;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1095;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1529);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_72,RoomSessionUserGivableBadgesEvent.const_72];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_72:
               ...
               break;
            case RoomSessionUserGivableBadgesEvent.const_72:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_672.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_672.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_662);
