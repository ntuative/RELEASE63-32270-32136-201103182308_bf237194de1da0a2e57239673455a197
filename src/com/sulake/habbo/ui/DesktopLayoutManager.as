package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1356:String = "room_view";
      
      private const const_2048:String = "room_widget";
      
      private var var_52:IWindowContainer;
      
      private var var_769:int = 50;
      
      private var var_2861:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_52.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_304,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_2048) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_52.getChildByTag(this.const_1356) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_769;
               _loc2_.width = this.var_52.desktop.width - this.var_769;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_769;
               _loc2_.height = this.var_52.desktop.height - this.var_769;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_52.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_52.findChildByTag(this.const_1356) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
