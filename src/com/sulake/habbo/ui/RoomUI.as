package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1084:IRoomWidgetFactory;
      
      private var var_321:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_517:IAvatarRenderManager;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1084.release(new IIDHabboRoomWidget());
            this.var_1084 = null;
         }
         ...
         {
            this.var_517.release(new IIDAvatarRenderManager());
            this.var_517 = null;
         }
         ...
         {
            this.var_877.release(new IIDHabboModeration());
            this.var_877 = null;
         }
         ...
         if(this.var_1083)
         {
            this.var_1083.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1083 = null;
         }
         this.var_1665 = null;
         ...
         if(this.var_294)
         {
            ...
            {
               _loc1_ = this.var_294.getKey(0) as String;
               _loc2_ = this.var_294.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1084 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_517 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_295.events.addEventListener(AdEvent.const_442,this.adEventHandler);
            this.var_295.events.addEventListener(AdEvent.const_554,this.adEventHandler);
            this.var_295.events.addEventListener(AdEvent.const_586,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_877 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_877);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_250,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_173,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_557,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_469,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_581,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_518,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_737,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1035,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1181,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_186,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_665,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_707,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_524,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_510,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_250:
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.ZOOM));
                  this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.MEMENU));
      ...
      {
         this.var_1083 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_808,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_691,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_242,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_643,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_548,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_440 || param1.type == RoomEngineEvent.const_482)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_689:
               ...
               if(this.var_1666 != RoomDesktop.const_768)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_317,this.var_1666);
               }
               if(this.var_295 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_808:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_691:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.moderation = this.var_877;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_549;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1083;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_806);
         _loc3_.init();
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_294.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_317);
            if(_loc3_ != RoomDesktop.const_768)
            {
               this.var_1666 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
      ...
      {
         return this.var_294.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_294.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
