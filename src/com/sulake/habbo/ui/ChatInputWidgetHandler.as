package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_787);
         _loc1_.push(RoomWidgetChatTypingMessage.const_824);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_787:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_824:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1212,HabboToolbarIconEnum.CHATINPUT,param1));
      }
