package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1084:IRoomWidgetFactory = null;
      
      private var var_321:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_517:IAvatarRenderManager = null;
      ...
      private var var_1085:IHabboHelp = null;
      
      private var _connection:IConnection = null;
      
      private var var_877:IHabboModeration;
      ...
      private var var_1083:IHabboUserDefinedRoomEvents;
      ...
      private var var_210:DesktopLayoutManager;
      ...
      private var var_232:IToolTipWindow;
      
      private var var_2670:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_210 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_731,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_188 = param1;
         this.var_188.events.addEventListener(HabboToolbarEvent.const_556,this.onToolbarRepositionEvent);
         this.var_188.events.addEventListener(HabboToolbarEvent.const_38,this.onHabboToolbarEvent);
      }
      
      public function set layout(param1:XML) : void
      {
         this.var_210.setLayout(param1,this._windowManager,this._config);
         if(this.var_188 != null)
         {
            this.var_210.toolbarSize = this.var_188.size;
            this.var_210.toolbarOrientation = this.var_188.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_789.length)
            {
               _loc6_ = this.var_789.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_731,this.onRoomContentLoaded);
         }
         ...
         {
            this.var_188.events.removeEventListener(HabboToolbarEvent.const_556,this.onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_32 != null)
         {
            this.var_788 = this._roomEngine.loadRoomResources(this.var_32.roomResources);
         ...
         if(this.var_295 != null && this.var_32.state == RoomSessionEvent.const_250)
         {
            this.var_1910 = !this.var_295.showInterstitial();
         }
      ...
      {
         if(this.var_788 == null || this.var_788.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_788.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1084.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_210.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_789.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_790.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_790.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_791.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_791.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc11_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_210.roomViewRect);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_791.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_652:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_384,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(this.var_877 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = this.var_32.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_175)
                  {
                     this.var_877.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_507:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_130,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_210.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_778);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_871);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_625);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_687);
         ...
         this.var_210.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2670);
      ...
      {
         var _loc3_:IWindowContainer = this.var_210.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_210.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_232 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_232.width / 2,15);
            this.var_232.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1912 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_32.roomId,this.var_32.roomCategory,this.var_316[0],_loc2_.width,_loc2_.height);
         if(this.var_479 == null)
         {
            this.var_479 = new Timer(const_1398,1);
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1912));
      }
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_210.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1909) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","RoomWidgetLetUserInMessage",_loc3_);
               }
               else
               {
      ...
      public function update() : void
      {
         ...
         var _loc1_:int = this.var_379.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_379.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         if(this.var_15 != null && this.var_32 != null && this.var_1910 && this.var_1911)
         {
            this.var_15.startSession(this.var_32);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_290));
         }
      }
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_456:
               ...
               this.var_232 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_359,WindowStyle.const_900,WindowParam.const_100) as IToolTipWindow;
               this.var_232.setParamFlag(WindowParam.const_29,false);
      ...
      public function addUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         if(this.var_379.indexOf(param1) == -1)
         {
      ...
      public function removeUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         var _loc2_:int = this.var_379.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_379.splice(_loc2_,1);
         }
      }
   }
}
