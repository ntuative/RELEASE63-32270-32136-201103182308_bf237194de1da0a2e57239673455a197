package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomImageLoader implements IDisposable
   {
      ...
      private var var_981:IBitmapWrapperWindow;
      ...
      public function OfficialRoomImageLoader(param1:HabboNavigator, param2:String, param3:IBitmapWrapperWindow)
      {
         ...
         this.var_1039 = _loc4_ + this.var_980;
         Logger.log("[OFFICIAL ROOM ICON IMAGE DOWNLOADER] : " + this.var_1039);
      }
      ...
      public function startLoad() : void
      {
         ...
         {
            _loc1_ = new URLRequest(this.var_1039);
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            Logger.log("Loading pic from url: " + this.var_1039 + " failed. loaderStruct == null");
            return;
         }
      ...
      private function setImage() : void
      {
         ...
         this.var_981.bitmap = _loc1_;
         this.var_981.width = _loc1_.width;
         this.var_981.height = _loc1_.height;
         this.var_981.visible = true;
         this.dispose();
      }
      
      private function onLoadError(param1:AssetLoaderEvent) : void
      {
         Logger.log("Error loading image: " + this.var_1039 + ", " + param1);
         this.dispose();
      }
