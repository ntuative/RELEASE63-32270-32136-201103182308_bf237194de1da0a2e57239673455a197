package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_293:MainViewCtrl;
      
      private var var_584:RoomInfoViewCtrl;
      
      private var var_1082:RoomCreateViewCtrl;
      ...
      private var var_2890:Dictionary;
      ...
      private var var_2232:RoomThumbnailRenderer;
      
      private var var_1033:GuestRoomPasswordInput;
      
      private var var_296:GuestRoomDoorbell;
      
      private var var_1081:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2233 = new Array();
         ...
         this.var_293 = new MainViewCtrl(this);
         this.var_584 = new RoomInfoViewCtrl(this);
         this.var_1082 = new RoomCreateViewCtrl(this);
         this.var_2232 = new RoomThumbnailRenderer(this);
         this.var_1033 = new GuestRoomPasswordInput(this);
         this.var_296 = new GuestRoomDoorbell(this);
         this.var_456 = new Tabs(this);
         this.var_1081 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_311,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_584.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_293.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_293.startSearch(Tabs.const_272,Tabs.const_388,param1);
         this.var_293.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_293.startSearch(Tabs.const_281,Tabs.const_221);
         this.var_456.getTab(Tabs.const_281).tabPageDecorator.tabSelected();
      }
