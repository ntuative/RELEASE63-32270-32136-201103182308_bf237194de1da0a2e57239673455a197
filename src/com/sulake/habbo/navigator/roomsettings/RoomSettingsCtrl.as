package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1276:TextFieldManager;
      
      private var var_996:TextFieldManager;
      
      private var var_998:TextFieldManager;
      
      private var var_1033:TextFieldManager;
      
      private var var_1277:TextFieldManager;
      
      private var var_1273:ICheckBoxWindow;
      
      private var var_1275:ICheckBoxWindow;
      ...
      private var var_2007:IWindowContainer;
      ...
      private var var_2809:ITextWindow;
      ...
      {
         this.var_394 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_394));
      ...
      {
         if(param1 != this.var_394 || this.var_1271 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1271 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1676)
         {
            this.var_827.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1432)
         {
            this.var_827.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1434)
         {
            this.var_1276.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1672)
         {
            this.setTagError(this.var_996,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_998,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1661)
         {
            this.setTagError(this.var_996,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_998,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1681)
         {
            this.var_1033.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1276.clearErrors();
         this.var_996.clearErrors();
         this.var_998.clearErrors();
         this.var_1033.clearErrors();
         this.var_1277.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_471,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_904,this.onDoorModePasswordUnselect);
         ...
         this.var_827 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1276 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_996 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_998 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1033 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1277 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1273 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1275 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1270 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_673 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2008 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1542 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1272 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1278 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2007 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1541 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_281 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1274 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2810 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2809 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1543 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1543.mouseThreshold = 0;
         this.var_1543.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1274.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2008.visible = this._inRoom;
         this.var_2007.visible = this._inRoom;
         this.var_2809.visible = this.var_548;
         this.var_2810.visible = !this.var_548;
         if(this.var_548)
         {
            this.var_1278.visible = true;
            this.var_1541.visible = false;
         ...
         else
         {
            ...
            this.var_1541.visible = true;
            this.var_1542.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1542.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1272.height = Util.getLowestPoint(this.var_1272) + 4;
         }
         this.var_1543.text = !!this.var_548 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_2008.name,this.var_1542.name,this.var_1272.name,this.var_1278.name,this.var_1541.name,this.var_2007.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_827.setText(_loc1_.name);
         this.var_1276.setText(_loc1_.description);
         this.var_1033.setText("");
         this.var_1277.setText("");
         ...
         this.setTag(this.var_996,_loc1_.tags[0]);
         this.setTag(this.var_998,_loc1_.tags[1]);
         if(this.var_1273)
         {
            if(_loc1_.allowPets)
            {
               this.var_1273.select();
            }
            else
            {
               this.var_1273.unselect();
            }
         }
         if(this.var_1275)
         {
            ...
            {
               this.var_1275.select();
            }
            else
            {
               this.var_1275.unselect();
            }
         }
         if(this.var_1270)
         {
            ...
            {
               this.var_1270.select();
            }
            else
            {
               this.var_1270.unselect();
            }
         }
         if(this.var_673)
         {
            ...
            {
               this.var_673.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_673.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_827.getText();
         _loc2_.description = this.var_1276.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_439;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_119)
         {
            _loc8_ = this.var_1033.getText();
            _loc9_ = this.var_1277.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1033.clearErrors();
               this.var_1277.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1273.isSelected;
         _loc2_.allowFoodConsume = this.var_1275.isSelected;
         _loc2_.allowWalkThrough = this.var_1270.isSelected;
         _loc2_.hideWalls = this.var_673.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_996,_loc2_.tags);
         this.addTag(this.var_998,_loc2_.tags);
         this.clearErrors();
         this.var_1271 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_394);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_79.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_394]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_62,HabboWindowStyle.const_31,HabboWindowParam.const_58,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_394));
      }
