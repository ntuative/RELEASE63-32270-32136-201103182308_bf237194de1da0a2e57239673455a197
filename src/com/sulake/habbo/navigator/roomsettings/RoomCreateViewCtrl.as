package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1727 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1727 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_185 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_60 = IItemListWindow(this.var_185.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_185.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1119 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_185.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_185.desktop,this.var_185.width,this.var_185.height);
         this.var_185.x = _loc4_.x;
         this.var_185.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1119.goBackToInitialState();
         this.var_1119.input.textBackgroundColor = 4294967295;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_62,HabboWindowStyle.const_31,HabboWindowParam.const_58,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1119.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_185.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_185.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1119.getText();
