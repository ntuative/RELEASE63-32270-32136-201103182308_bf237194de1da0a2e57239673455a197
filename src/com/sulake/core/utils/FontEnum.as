package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_618:Map = new Map();
      
      private static const const_333:Map = new Map();
      
      private static var var_1242:Boolean = false;
      ...
      {
         return const_618.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1242)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_618.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1242 = true;
         }
