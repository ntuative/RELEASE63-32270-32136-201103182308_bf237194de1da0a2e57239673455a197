package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1522:int = 4;
      ...
      {
         return this.var_408.length + this.var_285.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_285.length < const_1522 && this.var_408.length > 0)
            {
               _loc1_ = this.var_408.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_408.indexOf(loader);
            if(index > -1)
            {
               this.var_408.splice(index,1);
            }
