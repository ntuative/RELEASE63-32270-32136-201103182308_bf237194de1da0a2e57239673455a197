package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_101:uint = 3;
      
      private static const const_1388:String = "asset-libraries";
      
      private static const const_1392:String = "library";
      
      private static const const_1387:String = "service-libraries";
      
      private static const const_1395:String = "library";
      
      private static const const_1394:String = "component-libraries";
      
      private static const const_1389:String = "library";
      
      private static const const_1393:String = "error_data";
      
      private static const const_1390:String = "error_cat";
      
      private static const const_1391:String = "error_desc";
       
      
      private var var_377:LibraryLoaderQueue;
      
      private var var_785:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_398 = param1;
         var _loc3_:int = 0;
         while(_loc3_ < CoreComponentContext.const_101)
         {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_800:
               ...
               var_398.addChild(new ProfilerViewer(this.var_209));
               break;
            case Core.const_491:
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               i = 0;
               while(i < CoreComponentContext.const_101)
               {
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1393,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1390,String(param3));
         ErrorReportStorage.setParameter(const_1391,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_785 = loadingEventDelegate;
         if(this.var_377 == null)
         {
         ...
         try
         {
            node = config.child(const_1388)[0];
            if(node != null)
            {
               list = node.child(const_1392);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_303,e);
         }
         try
         {
            node = config.child(const_1387)[0];
            if(node != null)
            {
               list = node.child(const_1395);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_303,e);
         }
         try
         {
            node = config.child(const_1394)[0];
            if(node != null)
            {
               list = node.child(const_1389);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_303,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1445);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_785)
         {
            this.var_785.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_785)
         {
            ...
            this.var_785.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_785)
                  {
                     this.var_785.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_533 - this.var_377.length,this.var_533,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         param2 = param2 >= CoreComponentContext.const_101 ? 4294967295 : uint(param2);
         var _loc3_:int = !!this.var_209 ? 0 : this.var_1481 & 0;
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_209 ? 0 : this.var_1481 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_101)
         {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         priority = 0;
         while(priority < CoreComponentContext.const_101)
         {
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            _loc2_ = 0;
            while(_loc2_ < CoreComponentContext.const_101)
            {
