package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_414:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1149:uint = 4;
       
      
      protected var var_690:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1286 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1286);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1481 & const_1149)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_848 = false;
            this._events.dispatchEvent(new LockEvent(const_414,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_690 + "]";
      }
