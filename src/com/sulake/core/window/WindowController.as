package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1249:String = "_COLORIZE";
      
      protected static const const_1729:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_968:Point = new Point();
      ...
      protected var var_678:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_782 = _loc13_.blend;
            var_466 = _loc13_.var_2815;
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_100);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_100,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_100,true);
                  }
                  _loc3_++;
               }
            }
      ...
      {
         return this.var_678 != null ? this.var_678 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_465 = param1;
         var_238 = !!var_465 ? uint(var_238 | var_555) : uint(var_238 & 16777215);
      ...
      {
         var_555 = param1 & 4278190080;
         var_238 = !!var_465 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      ...
      {
         var_555 = param1 << 24;
         var_238 = !!var_465 ? uint(var_555 | var_238) : uint(16777215 & var_238);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      
      public function set blend(param1:Number) : void
      {
         var_782 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1225);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_559,this,null);
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_84 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_529,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set clipping(param1:Boolean) : void
      {
         ...
         {
            var_679 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_429,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_448,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1159,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_84,var_20,_context,var_11,null,this.var_678,this.properties,var_839.concat(),_id) as WindowController;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2501 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_479)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_532)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_561)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1049,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_702,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_467,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_191,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = 0;
         if(!testParamFlag(WindowParam.const_877))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1082;
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_325))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_191:
                  ...
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_564,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(testParamFlag(WindowParam.const_183,WindowParam.const_162))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_195,WindowParam.const_158))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_430))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_20 = _loc10_;
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_292,this._parent,this);
               ...
               case WindowNotifyEvent.const_467:
                  _context.invalidate(this,var_11.union(var_62),WindowRedrawFlag.const_473);
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1169,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_397:
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_735,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_559:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1032);
                  break;
               case WindowNotifyEvent.const_529:
                  ...
                  while(--_loc8_ > -1)
                  {
                     ...
                     if(_loc9_.tags.indexOf(const_1729) == -1)
                     {
                        _loc9_.style = var_84;
                     }
                  }
               ...
               case WindowNotifyEvent.const_276:
                  ...
                  break;
               case WindowNotifyEvent.const_743:
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1199:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1598:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1507:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1115:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_780:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1207:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1243:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_466);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_466);
      }
         ...
         if(this.var_177 && var_466 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_968,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_968,param3,param1)) : false;
            }
         }
      ...
      public function setStateFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_state != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_559,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_84 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_529,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_20 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_429,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_136,WindowParam.const_162);
         var _loc2_:* = !testParamFlag(WindowParam.const_140,WindowParam.const_158);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_353)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_195)
               {
      ...
      {
         if(_state == WindowState.const_585)
         {
            return true;
         }
         _state = WindowState.const_585;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1088,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1207;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1243,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1210,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_397;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1029,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1199;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1025,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1158,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1048,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1115,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_780;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1097,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1040,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1217;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_348,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_348,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_743,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
