package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1314:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1313:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_150:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_150 = this.profiler;
         this._windowManager = param2;
         this.var_960 = param3;
         var _loc4_:ByteArray = new var_1314() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_150)
         {
            this.var_150.removeStopEventListener(this.refresh);
            this.var_150 = null;
         }
         if(!this.var_150 && param1)
         {
            this.var_150 = param1;
            this.var_150.addStopEventListener(this.refresh);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_150.getProfilerAgentsInArray();
         ...
         if(this.var_1587)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_150.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_150.numBitmapAssetInstances + " / " + this.var_150.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_960.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_150.numTrackedBitmapDataInstances + " / " + this.var_150.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1313() as ByteArray;
