package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_391:Object = null;
      ...
      {
         return this.var_391 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_444);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_391 != null)
            {
               _loc1_.textColor = uint(this.var_391);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_444 != param1.name)
         {
            this.var_444 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2786 = _loc2_.textWidth;
         this.var_2785 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_391 != _loc2_.color : this.var_391 != null && this.var_391 != PropertyDefaults.const_783) ? new PropertyStruct(PropertyDefaults.const_345,this.var_391,PropertyStruct.const_148,true) : PropertyDefaults.const_1140);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_844)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,this.var_42.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_502);
            }
            if(this.var_42.top != PropertyDefaults.const_673)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_223,this.var_42.top,PropertyStruct.const_41,true));
            }
            else
            {
            ...
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_273,this.var_42.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_535);
            }
            if(this.var_42.bottom != PropertyDefaults.const_727)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_269,this.var_42.bottom,PropertyStruct.const_41,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_345:
                  this.var_391 = _loc2_.value as uint;
                  break;
