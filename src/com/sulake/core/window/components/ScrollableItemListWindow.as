package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1225:IItemListWindow;
      
      private var var_443:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_443)
         {
            this.var_443.removeEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            this.var_443.removeEventListener(WindowEvent.const_219,this.scrollBarEventProc);
            this.var_443 = null;
         }
         if(this.var_1225)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1225)
         {
            this.var_1225 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_443)
         {
            this.var_443 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_443)
            {
               this.var_443.addEventListener(WindowEvent.const_291,this.scrollBarEventProc);
               this.var_443.addEventListener(WindowEvent.const_219,this.scrollBarEventProc);
            }
         }
         return this.var_443;
      }
