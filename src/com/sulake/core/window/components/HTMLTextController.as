package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_861:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_862:String = "GetPetInventoryComposer";
      
      private var var_1064:String = null;
      
      private var var_1615:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1064 == param2)
         {
            return;
         }
         param1.var_1064 = param2;
         param1.var_1615 = null;
         if(param1.var_1064 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1064);
            param1.var_1615 = _loc3_;
         }
      }
      ...
      {
         return this.var_862 == LinkTarget.const_31 ? defaultLinkTarget : this.var_862;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1615;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_738)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_862 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_664,this.var_862,PropertyStruct.const_52,true,PropertyDefaults.const_739));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_664)
            {
