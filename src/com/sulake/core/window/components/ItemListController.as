package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2066:Boolean = false;
      
      protected var var_556:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_2881:Number = 0.0;
      
      protected var var_2882:Number = 0.0;
      
      protected var var_1043:Boolean = true;
      
      protected var var_467:Boolean = false;
      
      protected var var_1297:Boolean = false;
      
      protected var var_2067:int = 0;
      
      protected var var_2068:int = 0;
      
      protected var var_1299:Number;
      
      protected var var_1296:Number;
      
      protected var var_1298:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_177 = var_465 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_368,WindowStyle.const_900,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_47,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_489,this.containerEventHandler);
         ...
         this.resizeOnItemUpdate = this.var_1297;
      }
      ...
      {
         return new Rectangle(this.var_681 * this.maxScrollH,this.var_680 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_681 = param1;
            this._container.x = -this.var_681 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.REDRAW);
            dispatchEvent(new WindowEvent(WindowEvent.const_505,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_680 = param1;
            this._container.y = -this.var_680 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.REDRAW);
            dispatchEvent(new WindowEvent(WindowEvent.const_505,this,null));
         }
      }
      ...
      {
         this.var_2881 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2882 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_430,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_489,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_172:
               if(this.var_1298)
               {
                  this.var_1299 = this.var_2067 - _loc3_;
                  this.var_1296 = this.var_2068 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1299 != 0 && this.var_111 != 0)
                     {
                        this.scrollH += this.var_1299 / this.var_111;
                     }
                  }
                  else if(this.var_1296 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1296 / this.var_94;
                  }
                  this.var_2067 = _loc3_;
                  this.var_2068 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_199:
               if(this.var_1298)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1299,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1296);
                  }
                  this.var_1298 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1043 && !this.var_556 && this._container)
         {
            this.var_556 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_795)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_392,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1209);
         }
         if(this.var_1043 != PropertyDefaults.const_1021)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_759,this.var_1043,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1595);
         }
         if(this.var_467 != PropertyDefaults.const_1133)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_813,this.var_467,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1646);
         }
         if(this.var_1297 != PropertyDefaults.const_1041)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_807,this.var_1297,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1442);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_392:
               ...
               case PropertyDefaults.const_759:
                  this.var_1043 = _loc2_.value as Boolean;
                  break;
            }
         }
