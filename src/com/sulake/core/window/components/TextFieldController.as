package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1547:uint = 500;
      
      protected var var_1284:String = "";
      
      protected var var_1291:Boolean = false;
      
      protected var var_705:Boolean = false;
      ...
      {
         this.var_1284 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_705 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_410,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_793,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1462);
         _loc1_.push(this.var_1291 != PropertyDefaults.const_1245 ? new PropertyStruct(PropertyDefaults.const_694,this.var_1291,PropertyStruct.const_40,true) : PropertyDefaults.const_1435);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1042 ? new PropertyStruct(PropertyDefaults.const_799,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1567);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1009 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1651);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_694:
                  this.var_1291 = _loc2_.value as Boolean;
                  if(this.var_1291)
                  {
               ...
               case PropertyDefaults.const_793:
                  ...
                  break;
               case PropertyDefaults.const_1102:
