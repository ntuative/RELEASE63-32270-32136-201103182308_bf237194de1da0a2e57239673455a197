package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1250:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_841:Number;
      
      protected var var_558:Number;
      
      protected var var_557:Boolean;
      ...
      private var var_444:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_444,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_444 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_444,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_182);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_779 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_444);
      }
      ...
      {
         this.var_841 = param1;
         this._field.scrollH = this.var_841 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_841 * this.maxScrollH,this.var_558 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_444);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1186) ? new PropertyStruct(PropertyDefaults.const_634,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1162) : PropertyDefaults.const_1565);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1116 ? new PropertyStruct(PropertyDefaults.const_794,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1074) : PropertyDefaults.const_1500);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_233,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1138 ? new PropertyStruct(PropertyDefaults.const_1143,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1246) : PropertyDefaults.const_1605);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_783) ? new PropertyStruct(PropertyDefaults.const_345,this._field.textColor,PropertyStruct.const_148,true) : PropertyDefaults.const_1140);
         _loc1_.push(this.var_444 != TextStyleManager.const_182 ? new PropertyStruct(PropertyDefaults.const_399,this.var_444,PropertyStruct.const_52,true,PropertyDefaults.const_874) : PropertyDefaults.const_1190);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_844 ? new PropertyStruct(PropertyDefaults.const_268,this.var_42.left,PropertyStruct.const_41,true) : PropertyDefaults.const_502);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_673 ? new PropertyStruct(PropertyDefaults.const_223,this.var_42.top,PropertyStruct.const_41,true) : PropertyDefaults.const_569);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_812 ? new PropertyStruct(PropertyDefaults.const_273,this.var_42.right,PropertyStruct.const_41,true) : PropertyDefaults.const_535);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_727 ? new PropertyStruct(PropertyDefaults.const_269,this.var_42.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_568);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1120 ? new PropertyStruct(PropertyDefaults.const_785,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1488);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_271,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_271,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_271,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
