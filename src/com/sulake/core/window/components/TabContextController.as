package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1325:String = "_SELECTOR";
      
      private static const const_1326:String = "_CONTENT";
       
      
      protected var var_1040:ITabSelectorWindow;
      
      protected var var_2059:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1040 = findChildByTag(const_1325) as ITabSelectorWindow;
            if(this.var_1040 != null)
            {
               this.var_1040.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2059 = findChildByTag(const_1326) as IWindowContainer;
         }
      ...
      {
         return !!this.var_705 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1040.numSelectables;
      }
