   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this._window.addEventListener(WindowEvent.const_326,this.clientWindowDestroyed);
            this._working = true;
         }
         return _loc3_;
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_326,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_682);
         this._window.offset(this.var_682.x - this._offset.x,this.var_682.y - this._offset.y);
      }
