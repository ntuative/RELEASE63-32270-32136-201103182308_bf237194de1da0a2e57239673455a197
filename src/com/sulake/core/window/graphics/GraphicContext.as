package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1855:uint = 64;
      
      public static const const_1907:uint = 128;
      ...
      protected var var_2065:Boolean;
      
      protected var var_840:Boolean;
         ...
         if(this.var_840)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2065,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2065,16777215);
                  }
                  var_333 += bitmap.width * bitmap.height * 4;
               }
