package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1951:Point;
      
      private var var_1501:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1951 = new Point();
         this.var_1501 = new Rectangle();
         this.var_323 = new Rectangle();
         this.var_383 = new Dictionary(true);
         this.var_959 = param1;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_323.x = param2.x - param1.x;
            this.var_323.y = param2.y - param1.y;
            this.var_323.width = param2.width;
            this.var_323.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_323.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_323,WindowRedrawFlag.const_1093);
            if(this.var_802.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_383[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_383[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_959);
            this.var_383[param1] = _loc2_;
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_802.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_802.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_323.x = _loc3_.dirty.x;
               this.var_323.y = _loc3_.dirty.y;
               this.var_323.width = _loc3_.dirty.width;
               this.var_323.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_323,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1951,this.var_1501))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1951,this.var_1501))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_33))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1501);
