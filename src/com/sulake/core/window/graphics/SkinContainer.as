package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_970:uint = 8;
      
      private static const const_1344:String = "skin";
      
      private static const const_1342:String = "bitmap";
      
      private static const const_1341:String = "fill";
      
      private static const const_1340:String = "text";
      
      private static const const_1343:String = "label";
      
      private static const const_1345:String = "shape";
      ...
      private var var_2511:Dictionary;
      
      private var var_2510:Dictionary;
      
      private var var_2509:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2511 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1798,this.var_2511);
         this.var_2510 = new Dictionary();
         this.var_2509 = new Dictionary();
         StateCodeTable.fillTables(this.var_2510,this.var_2509);
         this.var_432 = new Dictionary();
         this.var_432[const_1344] = BitmapSkinRenderer;
         this.var_432[const_1342] = BitmapDataRenderer;
         this.var_432[const_1341] = FillSkinRenderer;
         this.var_432[const_1340] = TextSkinRenderer;
         this.var_432[const_1343] = LabelRenderer;
         this.var_432[const_1345] = ShapeSkinRenderer;
         this.var_432[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_432[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_332 == null)
         {
            var_332 = new Array();
            var_332.push(WindowState.const_69);
            var_332.push(WindowState.const_82);
            var_332.push(WindowState.const_97);
            var_332.push(WindowState.const_55);
            var_332.push(WindowState.const_95);
            var_332.push(WindowState.const_84);
            var_332.push(WindowState.const_102);
            var_332.push(WindowState.const_96);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2815 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1798[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_951[param1] = new Array(const_970);
         }
         this.var_951[param1][param2] = param3;
         if(this.var_952[param1] == null)
         {
            this.var_952[param1] = new Array(const_970);
         }
         this.var_952[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_174)
            {
               _loc4_ = _loc3_["null"];
            }
         }
