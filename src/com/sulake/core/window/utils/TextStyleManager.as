package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_182:String = "regular";
      ...
      private static const const_610:String = "{";
      
      private static const const_609:String = "}";
      
      private static const const_1361:String = "/*";
      
      private static const const_1360:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_87[const_182],var_87[ITALIC],var_87[BOLD]];
            var_87.reset();
            var_87[const_182] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_609);
         if(countSubStrings(param1,const_610) != countSubStrings(param1,const_609))
         {
            throw new Error("Mismatching amount of \"" + const_610 + "\" versus \"" + const_609 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1361) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1360) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_610)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
