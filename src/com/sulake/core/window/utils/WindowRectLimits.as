package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_307 = param1;
         if(this.var_307 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_307)
         {
      ...
      {
         this.var_306 = param1;
         if(this.var_306 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_306)
         {
      ...
      {
         return this.var_307 == int.MIN_VALUE && this.var_306 == int.MAX_VALUE && this.var_308 == int.MIN_VALUE && this.var_305 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_307)
            {
               this._target.width = this.var_307;
            }
            else if(this._target.width > this.var_306)
            {
               this._target.width = this.var_306;
            }
