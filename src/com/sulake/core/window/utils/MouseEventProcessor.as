package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_834:IWindowContextStateListener;
      ...
      {
         super();
         this.var_676 = new Point();
         if(var_331 == null)
         {
            var_331 = new Array();
            var_331[0] = MouseCursorType.const_312;
            var_331[1] = MouseCursorType.const_31;
            var_331[2] = MouseCursorType.const_312;
            var_331[3] = MouseCursorType.const_312;
            var_331[4] = MouseCursorType.const_312;
            var_331[5] = MouseCursorType.const_31;
            var_331[6] = MouseCursorType.const_312;
         }
         if(var_287 == null)
         {
            var_287 = new Array();
            var_287[0] = WindowState.const_102;
            var_287[1] = WindowState.const_84;
            var_287[2] = WindowState.const_95;
            var_287[3] = WindowState.const_69;
            var_287[4] = WindowState.const_55;
            var_287[5] = WindowState.const_97;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_72 = state.var_1281 as WindowController;
         this.var_175 = state.var_1279 as WindowController;
         this.var_173 = state.renderer;
         this.var_834 = state.var_1282;
         eventQueue.begin();
         this.var_676.x = -1;
         this.var_676.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_676.x || event.stageY != this.var_676.y)
            {
               this.var_676.x = event.stageX;
               this.var_676.y = event.stageY;
               array = new Array();
               this.var_145.groupParameterFilteredChildrenUnderPoint(this.var_676,array,WindowParam.const_29);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_72.getGlobalPosition(var_401);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_72 && !this.var_72.disposed)
                     {
                        ...
                        {
                           this.var_834.mouseEventReceived(event.type,this.var_72);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1281 = this.var_72;
         state.var_1279 = this.var_175;
         state.renderer = this.var_173;
         state.var_1282 = this.var_834;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_506))
         {
