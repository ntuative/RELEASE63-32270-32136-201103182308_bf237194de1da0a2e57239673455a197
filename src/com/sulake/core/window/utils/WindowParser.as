package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1154:String = "_EXCLUDE";
      
      public static const const_1842:String = "_INCLUDE";
      
      public static const const_1961:String = "_TEMP";
      
      private static const const_1381:String = "layout";
      
      private static const const_984:String = "window";
      
      private static const const_983:String = "variables";
      
      private static const const_982:String = "filters";
      
      private static const const_599:String = "name";
      
      private static const const_1370:String = "style";
      
      private static const const_612:String = "params";
      
      private static const const_1372:String = "tags";
      ...
      private static const const_1380:String = "visible";
      
      private static const const_1379:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1225:String = "blend";
      
      private static const const_1368:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1377:String = "treshold";
      
      private static const const_1371:String = "children";
      
      private static const const_1369:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1378:String = "height_min";
      
      private static const const_1376:String = "height_max";
      ...
      private static const const_1375:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1374:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1295:Dictionary;
      
      protected var var_1294:Dictionary;
      
      protected var var_1042:Dictionary;
      
      protected var var_1555:Dictionary;
      
      protected var var_2064:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1295,this.var_1294);
         this.var_1042 = new Dictionary();
         this.var_1555 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1042,this.var_1555);
         this.var_2064 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1374,const_49);
         return param1.replace(const_1375,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1295)
            {
               delete this.var_1295[_loc1_];
            }
            for(_loc1_ in this.var_1294)
            {
               delete this.var_1294[_loc1_];
            }
            for(_loc1_ in this.var_1042)
            {
               delete this.var_1042[_loc1_];
            }
            for(_loc1_ in this.var_1555)
            {
               delete this.var_1555[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1381)
         {
            ...
            _loc9_ = param1.child(const_982).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1295[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_599,variables,"")));
         style = uint(this.parseAttribute(xml,const_1370,variables,style));
         params = uint(this.parseAttribute(xml,const_612,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1372,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_171));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_171));
         rect.width = Number(this.parseAttribute(xml,const_1314,variables,const_171));
         rect.height = Number(this.parseAttribute(xml,const_1315,variables,const_171));
         visible = this.parseAttribute(xml,const_1380,variables,visible.toString()) == const_611;
         ...
         if(xml.child(const_612).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_1042[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_599)) + "\"!");
               }
               params |= this.var_1042[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1379,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1313);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1369,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1378,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1376,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_611;
         blend = Number(this.parseAttribute(xml,const_1225,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1368,variables,window.clipping.toString()) == const_611;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1377,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_982).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_195)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1294[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1154) == -1)
                  {
