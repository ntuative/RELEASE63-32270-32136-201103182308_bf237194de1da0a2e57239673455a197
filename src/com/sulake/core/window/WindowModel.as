package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_555:uint;
      
      protected var var_466:uint = 10;
      
      protected var var_679:Boolean = true;
      
      protected var var_324:Boolean = true;
      
      protected var var_782:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_84 = param4;
         this.var_839 = param8 == null ? new Array() : param8;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this._context = null;
            this._state = WindowState.const_585;
            this.var_839 = null;
         }
      }
