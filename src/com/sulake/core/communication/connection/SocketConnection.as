package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1511:int = 10000;
      ...
      private var var_1150:IEncryption;
      
      private var var_749:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_359 = new Timer(const_1511,1);
         this.var_359.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      {
         this.var_291.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_749.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_507)
         {
            this.var_507.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1150 != null)
         {
            _loc3_ = this.var_1150.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_749.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_749.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1150 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_749.getMessages(this.var_508,receivedMessages);
         try
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_508.writeByte(this.var_82.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_359.stop();
         this.var_1766 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_748));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1766 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_748));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_748));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_748));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_748));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_748));
