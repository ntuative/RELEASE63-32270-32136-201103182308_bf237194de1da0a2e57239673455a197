package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1118:String = "AssetLibraryReady";
      
      public static const const_631:String = "AssetLibraryLoaded";
      
      public static const const_1549:String = "AssetLibraryUnloaded";
      
      public static const const_1704:String = "AssetLibraryLoadError";
      
      private static const const_599:String = "name";
      
      private static const const_975:String = "asset";
      
      private static const const_976:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_977:String = "library";
      
      private static var var_310:Dictionary;
      
      private static var var_1837:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_523 = new Dictionary(false);
         this.var_962 = new Dictionary(false);
         this.var_164 = new Dictionary(false);
         var_963.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_637 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_977);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_599);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_976);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_637 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_637 == param1.url && this.var_965)
         {
            if(!this.var_964 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_638);
            }
            this.var_964 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1118));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_965 = false;
         this.var_637 = null;
         dispatchEvent(new Event(AssetLibrary.const_1549));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_523[param2.url];
         if(_loc4_ != null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_523[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_164[struct.assetName] == null)
                  {
                     ++this.var_436;
                     this.var_434.push(struct.assetName);
                  }
                  this.var_164[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_523[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_164[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return this.var_164[param1] != null || (this.var_638 != null ? this.var_638[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_164[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1837.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_638 = _loc2_.resource;
         this.var_637 = _loc2_.url;
         if(this.var_964)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_638);
         }
         this.var_965 = true;
         dispatchEvent(new Event(AssetLibrary.const_631));
         dispatchEvent(new Event(AssetLibrary.const_1118));
         if(this.var_964)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1704));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_977);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_599).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_637 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_638[param1]);
                  _loc6_ = _loc3_.child(const_976);
                  if(_loc6_.length())
                  {
