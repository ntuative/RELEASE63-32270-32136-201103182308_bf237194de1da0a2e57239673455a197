   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_535 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_106 is BitmapDataAsset)
         {
            ...
            this.var_1359 = BitmapDataAsset(this.var_106).var_1359;
            this.var_1360 = BitmapDataAsset(this.var_106).var_1360;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1359 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1360 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
