package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_463 = new AssetLibrary("lib-" + this.var_560++);
         this.var_30.push(this.var_463);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_560++);
         this.var_551.push(_loc3_);
      ...
      {
         return this.var_463.loadFromResource(param1,param2);
      }
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_551.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_551.length)
            {
               _loc3_ = this.var_551[_loc4_] as IAssetLibrary;
      ...
      {
         return this.var_463.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_463.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_463.createAsset(param1,param2);
      }
      ...
      {
         return this.var_463.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_463.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_463.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_463.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
